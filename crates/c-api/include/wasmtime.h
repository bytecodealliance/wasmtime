 ...
 * \brief Serializes =
 */
WASM_API_EXTERN void wasmtime_module_serialize(const wasmtime_module_t*, wasm_byte_vec_t* out);
WASM_API_EXTERN wasmtime_error_t* wasmtime_module_deserialize(wasm_engine_t*, const wasm_byte_vec_t*);
