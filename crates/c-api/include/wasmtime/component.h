...
/// \brief Value of #wasmtime_component_kind_t indicating a boolean
#define WASMTIME_COMPONENT_KIND_BOOL 0
/// \brief Value of #wasmtime_component_kind_t indicating a signed 8-bit integer
#define WASMTIME_COMPONENT_KIND_S8 1
/// \brief Value of #wasmtime_component_kind_t indicating an unsigned 8-bit integer
#define WASMTIME_COMPONENT_KIND_U8 2
/// \brief Value of #wasmtime_component_kind_t indicating a signed 16-bit integer
#define WASMTIME_COMPONENT_KIND_S16 3
/// \brief Value of #wasmtime_component_kind_t indicating an unsigned 16-bit integer
#define WASMTIME_COMPONENT_KIND_U16 4
/// \brief Value of #wasmtime_component_kind_t indicating a signed 32-bit integer
#define WASMTIME_COMPONENT_KIND_S32 5
/// \brief Value of #wasmtime_component_kind_t indicating an unsigned 32-bit integer
#define WASMTIME_COMPONENT_KIND_U32 6
/// \brief Value of #wasmtime_component_kind_t indicating a signed 64-bit integer
#define WASMTIME_COMPONENT_KIND_S64 7
/// \brief Value of #wasmtime_component_kind_t indicating an unsigned 64-bit integer
#define WASMTIME_COMPONENT_KIND_U64 8
/// \brief Value of #wasmtime_component_kind_t indicating an 32-bit floating point number
#define WASMTIME_COMPONENT_KIND_F32 9
/// \brief Value of #wasmtime_component_kind_t indicating an 64-bit floating point number
#define WASMTIME_COMPONENT_KIND_F64 10
/// \brief Value of #wasmtime_component_kind_t indicating a unicode character
#define WASMTIME_COMPONENT_KIND_CHAR 11
/// \brief Value of #wasmtime_component_kind_t indicating a unicode string
#define WASMTIME_COMPONENT_KIND_STRING 12
/// \brief Value of #wasmtime_component_kind_t indicating a list
#define WASMTIME_COMPONENT_KIND_LIST 13
/// \brief Value of #wasmtime_component_kind_t indicating a record
#define WASMTIME_COMPONENT_KIND_RECORD 14
/// \brief Value of #wasmtime_component_kind_t indicating a tuple
#define WASMTIME_COMPONENT_KIND_TUPLE 15
/// \brief Value of #wasmtime_component_kind_t indicating a variant
#define WASMTIME_COMPONENT_KIND_VARIANT 16
/// \brief Value of #wasmtime_component_kind_t indicating an enum
#define WASMTIME_COMPONENT_KIND_ENUM 17
/// \brief Value of #wasmtime_component_kind_t indicating an option
#define WASMTIME_COMPONENT_KIND_OPTION 18
/// \brief Value of #wasmtime_component_kind_t indicating a result
#define WASMTIME_COMPONENT_KIND_RESULT 19
/// \brief Value of #wasmtime_component_kind_t indicating a set of flags
...
/// \brief Representation of a variant value
typedef struct wasmtime_component_val_variant_t {
  /// \brief Discriminant indicating the index of the variant case of this value
  uint32_t discriminant;
  /// \brief #wasmtime_component_val_t value of the variant case of this value if it has one
...
typedef struct wasmtime_component_val_result_t {
  /// \brief Value of the result, either of the ok type or of the error type, depending on #error
  wasmtime_component_val_t *val;
  /// \brief Discriminant indicating if this result is an ok value or an error
  bool error;
} wasmtime_component_val_result_t;

/// \brief Representation of an enum value
typedef struct wasmtime_component_val_enum_t {
  /// \brief Discriminant indicating the index of this value in the enum
  uint32_t discriminant;
 ...
 *
 * Setting any dynamic data to one of this field means that the payload now owns it
 */
typedef union wasmtime_component_val_payload_t {
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_BOOLEAN
  bool boolean;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_S8
  int8_t s8;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_U8
  uint8_t u8;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_S16
  int16_t s16;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_U16
  uint16_t u16;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_S32
  int32_t s32;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_U32
  uint32_t u32;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_S64
  int64_t s64;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_U64
  uint64_t u64;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_F32
  float f32;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_F64
  double f64;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_CHARACTER
  uint8_t character;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_STRING
  wasm_name_t string;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_LIST
  wasmtime_component_val_vec_t list;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_RECORD
  wasmtime_component_val_record_t record;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_TUPLE
  wasmtime_component_val_vec_t tuple;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_VARIANT
  wasmtime_component_val_variant_t variant;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_ENUMERATION
  wasmtime_component_val_enum_t enumeration;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_OPTION
  wasmtime_component_val_t *option;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_RESULT
  wasmtime_component_val_result_t result;
  /// \brief Field used if #wasmtime_component_val_t::kind is #WASMTIME_COMPONENT_KIND_FLAGS
 ...
 *
 * Many kind of values own data, so those need to be properly dropped in wasmtime,
 * and therefore should not live on the stack.
 */
typedef struct wasmtime_component_val_t {
  /// \brief Discriminant indicating which field of #payload is valid
  wasmtime_component_kind_t kind;
  /// \brief Container for the value data
...
/// \brief Representation of record field.
...
/**
 * \brief Sets the value of a flag within within a #wasmtime_component_val_flags_t.
 *
...
/**
 * \brief Tests the value of a flag within within a #wasmtime_component_val_flags_t.
 *
 * If this bit set is too small to hold a value at `index` it will be resized.
 ...
 *
 * This is usually used to create inner values, typically as part of an option or result.
 * In this case, ownership is given out to the outer value.
 *
 * In case where a top level #wasmtime_component_val_t is created (for example to be passed directly
 * to #wasmtime_component_func_call), then it should be deleted with #wasmtime_component_val_delete
 *
...
/**
 * \brief Deletes a #wasmtime_component_val_t previously created by #wasmtime_component_val_new
 *
 * This should not be called if the value has been given out as part of an outer #wasmtime_component_val_t
 *
...
/**
 * \brief Representation of a field in a record type or a case in a variant type
 */
typedef struct wasmtime_component_type_field_t {
  /// \brief Name of the record field or variant case
  wasm_name_t name;
  /// \brief Type of the record field or variant case (may be null for variant case)
...
/**
 * \brief Representation of a result type
 */
typedef struct wasmtime_component_type_result_t {
  /// \brief Type of the ok value (if there is one)
  wasmtime_component_type_t* ok_ty;
  /// \brief Type of the error value (if there is one)
  wasmtime_component_type_t* err_ty;
} wasmtime_component_type_result_t;

/**
 * \brief Container for different kind of component model type data
 */
typedef union wasmtime_component_type_payload_t
{
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_LIST
  wasmtime_component_type_t* list;
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_RECORD
  wasmtime_component_type_field_vec_t record;
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_TUPLE
  wasmtime_component_type_vec_t tuple;
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_VARIANT
  wasmtime_component_type_field_vec_t variant;
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_ENUM
  wasmtime_component_string_vec_t enumeration;
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_OPTION
  wasmtime_component_type_t* option;
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_RESULT
  wasmtime_component_type_result_t result;
  /// \brief Field used if #wasmtime_component_type_t::kind is #WASMTIME_COMPONENT_KIND_FLAGS
 ...
 *
 * Many kind of types own data, so those need to be properly dropped in wasmtime,
 * and therefore should not live on the stack.
 */
typedef struct wasmtime_component_type_t {
  /// \brief Discriminant indicating what kind of type it is, and which field of #payload is valid, if any
  wasmtime_component_kind_t kind;
  /// \brief Container for the type data, if any
 ...
 *
 * This is usually used to create inner types, typically as part of an option or result.
 * In this case, ownership is given out to the outer value.
 *
 * In case where a top level #wasmtime_component_type_t is created (for example to be passed directly to
 * #wasmtime_component_linker_define_func), then it should be deleted with #wasmtime_component_type_delete
 *
...
/**
 * \brief Deletes a #wasmtime_component_type_t previously created by #wasmtime_component_type_new
 *
 * This should not be called if the type has been given out as part of an outer #wasmtime_component_type_t
 *
...
/**
 * \brief Representation of a component in the component model.
 */
 ...
 * \param component_out on success, contains the address of the created component
...
/**
 * \brief Deletes a #wasmtime_component_t created by #wasmtime_component_from_binary
 *
 ...
 * #wasmtime_component_linker_define_func, then call #wasmtime_component_linker_build
 * to create and populate the root `wasmtime::component::LinkerInstance` and it's
 * descendants (if any).
 */
...
/**
 * \brief Deletes a #wasmtime_component_linker_t created by #wasmtime_component_linker_new
 *
...
/// \brief Representation of a component instance
 ...
 *
 * \param env a user-provided argument passed to #wasmtime_component_linker_define_func
 ...
 *
 * \param linker the #wasmtime_component_linker_t in which the function should be defined
 * \param path the dot-separated path of the package where the function is defined
 * \param path_len the byte length of `path`
 * \param name the name of the function
 * \param name_len the byte length of `name`
 * \param params_types_buf a pointer to an array of #wasmtime_component_type_t describing the function's parameters
 * \param params_types_len the length of `params_types_buf`
 * \param outputs_types_buf a pointer to an array of #wasmtime_component_type_t describing the function's outputs
 * \param outputs_types_len the length of `outputs_types_buf`
 * \param cb a pointer to the actual functions, a #wasmtime_component_func_callback_t
 ...
 * \return wasmtime_error_t* on success `NULL` is returned, otherwise an error is returned which
...
/**
 * \brief Builds the linker, providing the host functions defined by calls to #wasmtime_component_linker_define_func
 *
 * \param linker the #wasmtime_component_linker_t to build
 * \return wasmtime_error_t* On success `NULL` is returned, otherwise an error is returned which
 * describes why the build failed.
 */
 ...
 *
 * \param linker a #wasmtime_component_linker_t that will help provide host functions
 * \param context the #wasmtime_context_t in which the instance should be created
 * \param component the #wasmtime_component_t to instantiate
 * \param instance_out on success, the instantiated #wasmtime_component_instance_t
 * \return wasmtime_error_t* on success `NULL` is returned, otherwise an error is returned which
 * describes why the build failed.
 */
...
/// \brief Representation of an exported function in Wasmtime component model.
 ...
 *
 * \param instance the #wasmtime_component_instance_t in which the function should be looked for
 ...
 *
 * It is the responsibility of the caller to make sure that `params` has the expected
 * length, and the correct types, else the call will error out. `results` must have the
 * expected length, but the values will be written with the correct types.
 *
 * This can fail in two ways : either a non-NULL #wasmtime_error_t is returned, for example if the
 * parameters are incorrect (and `trap_out` will be NULL), or the call may trap, in which case
 * NULL is returned, but `trap_out` will be non-NULL.
 *
 * Does not take ownership of #wasmtime_component_val_t arguments. Gives ownership of
 * #wasmtime_component_val_t results. As such, if those are data-owning values, they
 * should be created and deleted through this api, either directly with #wasmtime_component_val_new,
 * or through a #wasmtime_component_val_vec_t, using #wasmtime_component_val_vec_new and
 * #wasmtime_component_val_vec_delete
 *
 * \param func the function to call, typically found with #wasmtime_component_instance_get_func
 * \param context the #wasmtime_context_t that contains `func`
 * \param params the parameters of `func`, as an array of #wasmtime_component_val_t
 * \param params_len the length of `params`
 * \param results the results of `func`, as an array of #wasmtime_component_val_t that will be written
 * \param results_len the length of `results`
 * \param trap_out NULL if the call completed successfully or couldn't be made, otherwise the trap that was raised
 * \return wasmtime_error_t* NULL on success or a description of the error calling the function
 */
