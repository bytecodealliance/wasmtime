...
fn build_and_generate_tests() {
    ...
    modules_rs(&meta, "wasi-sockets-tests", "bin", &out_dir);
    // FIXME like wasi-http-tests above, this is broken at the moment.
    //components_rs(&meta, "wasi-sockets-tests", "bin", &command_adapter, &out_dir);
}
