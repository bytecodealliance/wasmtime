...
pub mod random{
  ...
  pub fn insecure_random() -> (u64,u64,){
    ...
    unsafe {
      ...
      wit_import(ptr0);
      (*((ptr0 + 0) as *const i64) as u64, *((ptr0 + 8) as *const i64) as u64)
    }
  }
...
pub mod types{
  ...
  impl<'a,> core::fmt::Debug for SchemeParam<'a,> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      match self {
        SchemeParam::Http => {
          f.debug_tuple("SchemeParam::Http").finish()
        }
        SchemeParam::Https => {
          f.debug_tuple("SchemeParam::Https").finish()
        }
        SchemeParam::Other(e) => {
          f.debug_tuple("SchemeParam::Other").field(e).finish()
        }
      }
    }
  }
  ...
  impl core::fmt::Debug for SchemeResult {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      match self {
        SchemeResult::Http => {
          f.debug_tuple("SchemeResult::Http").finish()
        }
        SchemeResult::Https => {
          f.debug_tuple("SchemeResult::Https").finish()
        }
        SchemeResult::Other(e) => {
          f.debug_tuple("SchemeResult::Other").field(e).finish()
        }
      }
    }
  }
  ...
  impl<'a,> core::fmt::Debug for MethodParam<'a,> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      match self {
        MethodParam::Get => {
          f.debug_tuple("MethodParam::Get").finish()
        }
        MethodParam::Head => {
          f.debug_tuple("MethodParam::Head").finish()
        }
        MethodParam::Post => {
          f.debug_tuple("MethodParam::Post").finish()
        }
        MethodParam::Put => {
          f.debug_tuple("MethodParam::Put").finish()
        }
        MethodParam::Delete => {
          f.debug_tuple("MethodParam::Delete").finish()
        }
        MethodParam::Connect => {
          f.debug_tuple("MethodParam::Connect").finish()
        }
        MethodParam::Options => {
          f.debug_tuple("MethodParam::Options").finish()
        }
        MethodParam::Trace => {
          f.debug_tuple("MethodParam::Trace").finish()
        }
        MethodParam::Patch => {
          f.debug_tuple("MethodParam::Patch").finish()
        }
        MethodParam::Other(e) => {
          f.debug_tuple("MethodParam::Other").field(e).finish()
        }
      }
    }
  }
  ...
  impl core::fmt::Debug for MethodResult {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      match self {
        MethodResult::Get => {
          f.debug_tuple("MethodResult::Get").finish()
        }
        MethodResult::Head => {
          f.debug_tuple("MethodResult::Head").finish()
        }
        MethodResult::Post => {
          f.debug_tuple("MethodResult::Post").finish()
        }
        MethodResult::Put => {
          f.debug_tuple("MethodResult::Put").finish()
        }
        MethodResult::Delete => {
          f.debug_tuple("MethodResult::Delete").finish()
        }
        MethodResult::Connect => {
          f.debug_tuple("MethodResult::Connect").finish()
        }
        MethodResult::Options => {
          f.debug_tuple("MethodResult::Options").finish()
        }
        MethodResult::Trace => {
          f.debug_tuple("MethodResult::Trace").finish()
        }
        MethodResult::Patch => {
          f.debug_tuple("MethodResult::Patch").finish()
        }
        MethodResult::Other(e) => {
          f.debug_tuple("MethodResult::Other").field(e).finish()
        }
      }
    }
  }
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
      match self {
        ...
        ErrorParam::UnexpectedError(e) => {
          f.debug_tuple("ErrorParam::UnexpectedError").field(e).finish()
        }
      }
    }
  }
  impl<'a,> core::fmt::Display for ErrorParam<'a,> {
    ...
    impl core::fmt::Debug for ErrorResult {
      fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
          ...
          ErrorResult::ProtocolError(e) => {
            f.debug_tuple("ErrorResult::ProtocolError").field(e).finish()
          }
          ErrorResult::UnexpectedError(e) => {
            f.debug_tuple("ErrorResult::UnexpectedError").field(e).finish()
          }
        }
      }
    }
    impl core::fmt::Display for ErrorResult {
      ...
      pub fn new_fields(entries: &[(&str,&str,)],) -> Fields{
        ...
        #[allow(clippy::all)]
        pub fn fields_get(fields: Fields,name: &str,) -> wit_bindgen::rt::vec::Vec::<wit_bindgen::rt::string::String>{
          ...
          unsafe {
            ...
            for i in 0..len3 {
              ...
              result3.push({
                ...
                String::from_utf8(Vec::from_raw_parts(*((base + 0) as *const i32) as *mut _, len2, len2)).unwrap()
              });
            }
        ...
        pub fn fields_set(fields: Fields,name: &str,value: &[&str],) -> (){
          ...
          #[allow(clippy::all)]
          pub fn fields_entries(fields: Fields,) -> wit_bindgen::rt::vec::Vec::<(wit_bindgen::rt::string::String,wit_bindgen::rt::string::String,)>{
            ...
            unsafe {
              ...
              match i32::from(*((ptr0 + 0) as *const u8)) {
                ...
                9 => MethodResult::Other({
                  ...
                  String::from_utf8(Vec::from_raw_parts(*((ptr0 + 4) as *const i32) as *mut _, len1, len1)).unwrap()
                }),
                _ => panic!("invalid enum discriminant"),
              }
            }
          ...
          pub fn incoming_request_path(request: IncomingRequest,) -> wit_bindgen::rt::string::String{
            ...
            unsafe {
              ...
              wit_import(wit_bindgen::rt::as_i32(request), ptr0);
              let len1 = *((ptr0 + 4) as *const i32) as usize;
              String::from_utf8(Vec::from_raw_parts(*((ptr0 + 0) as *const i32) as *mut _, len1, len1)).unwrap()
            }
          }
          #[allow(clippy::all)]
          pub fn incoming_request_query(request: IncomingRequest,) -> wit_bindgen::rt::string::String{
            ...
            unsafe {
              ...
              extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "types_incoming-request-query")]
                fn wit_import(
                _: i32, _: i32, );
              }
              wit_import(wit_bindgen::rt::as_i32(request), ptr0);
              ...
              match i32::from(*((ptr0 + 0) as *const u8)) {
                ...
                1 => Some(match i32::from(*((ptr0 + 4) as *const u8)) {
                  ...
                  2 => SchemeResult::Other({
                    ...
                    String::from_utf8(Vec::from_raw_parts(*((ptr0 + 8) as *const i32) as *mut _, len1, len1)).unwrap()
                  }),
                  _ => panic!("invalid enum discriminant"),
                }),
                _ => panic!("invalid enum discriminant"),
          ...
          #[allow(clippy::all)]
          pub fn new_outgoing_request(method: MethodParam<'_,>,path: &str,query: &str,scheme: Option<SchemeParam<'_,>>,authority: &str,headers: Headers,) -> OutgoingRequest{
            ...
            unsafe {
              ...
              let ret = wit_import(result1_0, result1_1, result1_2, ptr2, len2, ptr3, len3, result6_0, result6_1, result6_2, result6_3, ptr7, len7, wit_bindgen::rt::as_i32(headers));
              ret as u32
            }
          }
          #[allow(clippy::all)]
          ...
          #[allow(clippy::all)]
          pub fn set_response_outparam(response: Result<OutgoingResponse,ErrorParam<'_,>>,) -> Result<(),()>{
          ...
          #[allow(clippy::all)]
          pub fn future_incoming_response_get(f: FutureIncomingResponse,) -> Option<Result<IncomingResponse,ErrorResult>>{
                ...
                1 => Some(match i32::from(*((ptr0 + 4) as *const u8)) {
                  ...
                  1 => Err(match i32::from(*((ptr0 + 8) as *const u8)) {
                    0 => ErrorResult::InvalidUrl({
                      ...
                      String::from_utf8(Vec::from_raw_parts(*((ptr0 + 12) as *const i32) as *mut _, len1, len1)).unwrap()
                    }),
                    1 => ErrorResult::TimeoutError({
                      let len2 = *((ptr0 + 16) as *const i32) as usize;
                      
                      String::from_utf8(Vec::from_raw_parts(*((ptr0 + 12) as *const i32) as *mut _, len2, len2)).unwrap()
                    }),
                    2 => ErrorResult::ProtocolError({
                      let len3 = *((ptr0 + 16) as *const i32) as usize;
                      
                      String::from_utf8(Vec::from_raw_parts(*((ptr0 + 12) as *const i32) as *mut _, len3, len3)).unwrap()
                    }),
                    3 => ErrorResult::UnexpectedError({
                      let len4 = *((ptr0 + 16) as *const i32) as usize;
                      
                      String::from_utf8(Vec::from_raw_parts(*((ptr0 + 12) as *const i32) as *mut _, len4, len4)).unwrap()
                    }),
                    _ => panic!("invalid enum discriminant"),
                  }),
                  _ => panic!("invalid enum discriminant"),
          ...
          pub fn handle(request: OutgoingRequest,options: Option<RequestOptions>,) -> FutureIncomingResponse{
            ...
            unsafe {
              let (result4_0,result4_1,result4_2,result4_3,result4_4,result4_5,result4_6,) = match options {
                Some(e) => {
                  let RequestOptions{ connect_timeout_ms:connect_timeout_ms0, first_byte_timeout_ms:first_byte_timeout_ms0, between_bytes_timeout_ms:between_bytes_timeout_ms0, } = e;
