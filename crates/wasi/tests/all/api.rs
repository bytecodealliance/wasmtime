...
wasmtime::component::bindgen!({
    ...
    with: {
       ...
       "wasi:filesystem/types@0.2.0": preview2::bindings::filesystem::types,
       "wasi:filesystem/preopens@0.2.0": preview2::bindings::filesystem::preopens,
       ...
       "wasi:cli/terminal_input@0.2.0": preview2::bindings::cli::terminal_input,
       "wasi:cli/terminal_output@0.2.0": preview2::bindings::cli::terminal_output,
       "wasi:cli/terminal_stdin@0.2.0": preview2::bindings::cli::terminal_stdin,
       "wasi:cli/terminal_stdout@0.2.0": preview2::bindings::cli::terminal_stdout,
       "wasi:cli/terminal_stderr@0.2.0": preview2::bindings::cli::terminal_stderr,
    },
    ownership: Borrowing {
