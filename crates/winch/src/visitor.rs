...
macro_rules! for_each_unsupported_op {
	...
	$def! {
	    ...
	    @mvp Nop => visit_nop
	    @mvp Block { _blockty: wasmparser::BlockType } => visit_block
	    @mvp Loop { _blockty: wasmparser::BlockType } => visit_loop
	    @mvp If { _blockty: wasmparser::BlockType } => visit_if
	    @mvp Else => visit_else
	    @exceptions Try { _blockty: wasmparser::BlockType } => visit_try
	    @exceptions Catch { _tag_index: u32 } => visit_catch
	    @exceptions Throw { _tag_index: u32 } => visit_throw
	    @exceptions Rethrow { _relative_depth: u32 } => visit_rethrow
	    // @mvp End => visit_end
	    @mvp Br { _relative_depth: u32 } => visit_br
	    @mvp BrIf { _relative_depth: u32 } => visit_br_if
	    @mvp BrTable { _targets: wasmparser::BrTable<'a> } => visit_br_table
	    @mvp Return => visit_return
	    @mvp Call { _function_index: u32 } => visit_call
	    @mvp CallIndirect { _type_index: u32, _table_index: u32, _table_byte: u8 } => visit_call_indirect
	    @tail_calls ReturnCall { _function_index: u32 } => visit_return_call
	    @tail_calls ReturnCallIndirect { _type_index: u32, _table_index: u32 } => visit_return_call_indirect
	    @exceptions Delegate { _relative_depth: u32 } => visit_delegate
	    @exceptions CatchAll => visit_catch_all
	    @mvp Drop => visit_drop
	    @mvp Select => visit_select
	    @reference_types TypedSelect { _ty: wasmparser::ValType } => visit_typed_select
	    @mvp LocalTee { _local_index: u32 } => visit_local_tee
	    @mvp GlobalGet { _global_index: u32 } => visit_global_get
	    @mvp GlobalSet { _global_index: u32 } => visit_global_set
	    @mvp I32Load { _memarg: wasmparser::MemArg } => visit_i32_load
	    @mvp I64Load { _memarg: wasmparser::MemArg } => visit_i64_load
	    @mvp F32Load { _memarg: wasmparser::MemArg } => visit_f32_load
	    @mvp F64Load { _memarg: wasmparser::MemArg } => visit_f64_load
	    @mvp I32Load8S { _memarg: wasmparser::MemArg } => visit_i32_load8_s
	    @mvp I32Load8U { _memarg: wasmparser::MemArg } => visit_i32_load8_u
	    @mvp I32Load16S { _memarg: wasmparser::MemArg } => visit_i32_load16_s
	    @mvp I32Load16U { _memarg: wasmparser::MemArg } => visit_i32_load16_u
	    @mvp I64Load8S { _memarg: wasmparser::MemArg } => visit_i64_load8_s
	    @mvp I64Load8U { _memarg: wasmparser::MemArg } => visit_i64_load8_u
	    @mvp I64Load16S { _memarg: wasmparser::MemArg } => visit_i64_load16_s
	    @mvp I64Load16U { _memarg: wasmparser::MemArg } => visit_i64_load16_u
	    @mvp I64Load32S { _memarg: wasmparser::MemArg } => visit_i64_load32_s
	    @mvp I64Load32U { _memarg: wasmparser::MemArg } => visit_i64_load32_u
	    @mvp I32Store { _memarg: wasmparser::MemArg } => visit_i32_store
	    @mvp I64Store { _memarg: wasmparser::MemArg } => visit_i64_store
	    @mvp F32Store { _memarg: wasmparser::MemArg } => visit_f32_store
	    @mvp F64Store { _memarg: wasmparser::MemArg } => visit_f64_store
	    @mvp I32Store8 { _memarg: wasmparser::MemArg } => visit_i32_store8
	    @mvp I32Store16 { _memarg: wasmparser::MemArg } => visit_i32_store16
	    @mvp I64Store8 { _memarg: wasmparser::MemArg } => visit_i64_store8
	    @mvp I64Store16 { _memarg: wasmparser::MemArg } => visit_i64_store16
	    @mvp I64Store32 { _memarg: wasmparser::MemArg } => visit_i64_store32
	    @mvp MemorySize { _mem: u32, _mem_byte: u8 } => visit_memory_size
	    @mvp MemoryGrow { _mem: u32, _mem_byte: u8 } => visit_memory_grow
	    @mvp I64Const { _value: i64 } => visit_i64_const
	    @mvp F32Const { _value: wasmparser::Ieee32 } => visit_f32_const
	    @mvp F64Const { _value: wasmparser::Ieee64 } => visit_f64_const
	    @reference_types RefNull { _ty: wasmparser::ValType } => visit_ref_null
	    @reference_types RefIsNull => visit_ref_is_null
	    @reference_types RefFunc { _function_index: u32 } => visit_ref_func
	    ...
	    @bulk_memory MemoryInit { _data_index: u32, _mem: u32 } => visit_memory_init
	    @bulk_memory DataDrop { _data_index: u32 } => visit_data_drop
	    @bulk_memory MemoryCopy { _dst_mem: u32, _src_mem: u32 } => visit_memory_copy
	    @bulk_memory MemoryFill { _mem: u32 } => visit_memory_fill
	    @bulk_memory TableInit { _elem_index: u32, _table: u32 } => visit_table_init
	    @bulk_memory ElemDrop { _elem_index: u32 } => visit_elem_drop
	    @bulk_memory TableCopy { _dst_table: u32, _src_table: u32 } => visit_table_copy
	    @bulk_memory TableFill { _table: u32 } => visit_table_fill
	    @bulk_memory TableGet { _table: u32 } => visit_table_get
	    @bulk_memory TableSet { _table: u32 } => visit_table_set
	    @bulk_memory TableGrow { _table: u32 } => visit_table_grow
	    @bulk_memory TableSize { _table: u32 } => visit_table_size

	    // 0xFE operators
	    // https://github.com/WebAssembly/threads/blob/master/proposals/threads/Overview.md
	    @threads MemoryAtomicNotify { _memarg: wasmparser::MemArg } => visit_memory_atomic_notify
	    @threads MemoryAtomicWait32 { _memarg: wasmparser::MemArg } => visit_memory_atomic_wait32
	    @threads MemoryAtomicWait64 { _memarg: wasmparser::MemArg } => visit_memory_atomic_wait64
	    @threads AtomicFence => visit_atomic_fence
	    @threads I32AtomicLoad { _memarg: wasmparser::MemArg } => visit_i32_atomic_load
	    @threads I64AtomicLoad { _memarg: wasmparser::MemArg } => visit_i64_atomic_load
	    @threads I32AtomicLoad8U { _memarg: wasmparser::MemArg } => visit_i32_atomic_load8_u
	    @threads I32AtomicLoad16U { _memarg: wasmparser::MemArg } => visit_i32_atomic_load16_u
	    @threads I64AtomicLoad8U { _memarg: wasmparser::MemArg } => visit_i64_atomic_load8_u
	    @threads I64AtomicLoad16U { _memarg: wasmparser::MemArg } => visit_i64_atomic_load16_u
	    @threads I64AtomicLoad32U { _memarg: wasmparser::MemArg } => visit_i64_atomic_load32_u
	    @threads I32AtomicStore { _memarg: wasmparser::MemArg } => visit_i32_atomic_store
	    @threads I64AtomicStore { _memarg: wasmparser::MemArg } => visit_i64_atomic_store
	    @threads I32AtomicStore8 { _memarg: wasmparser::MemArg } => visit_i32_atomic_store8
	    @threads I32AtomicStore16 { _memarg: wasmparser::MemArg } => visit_i32_atomic_store16
	    @threads I64AtomicStore8 { _memarg: wasmparser::MemArg } => visit_i64_atomic_store8
	    @threads I64AtomicStore16 { _memarg: wasmparser::MemArg } => visit_i64_atomic_store16
	    @threads I64AtomicStore32 { _memarg: wasmparser::MemArg } => visit_i64_atomic_store32
	    @threads I32AtomicRmwAdd { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw_add
	    @threads I64AtomicRmwAdd { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw_add
	    @threads I32AtomicRmw8AddU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw8_add_u
	    @threads I32AtomicRmw16AddU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw16_add_u
	    @threads I64AtomicRmw8AddU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw8_add_u
	    @threads I64AtomicRmw16AddU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw16_add_u
	    @threads I64AtomicRmw32AddU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw32_add_u
	    @threads I32AtomicRmwSub { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw_sub
	    @threads I64AtomicRmwSub { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw_sub
	    @threads I32AtomicRmw8SubU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw8_sub_u
	    @threads I32AtomicRmw16SubU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw16_sub_u
	    @threads I64AtomicRmw8SubU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw8_sub_u
	    @threads I64AtomicRmw16SubU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw16_sub_u
	    @threads I64AtomicRmw32SubU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw32_sub_u
	    @threads I32AtomicRmwAnd { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw_and
	    @threads I64AtomicRmwAnd { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw_and
	    @threads I32AtomicRmw8AndU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw8_and_u
	    @threads I32AtomicRmw16AndU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw16_and_u
	    @threads I64AtomicRmw8AndU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw8_and_u
	    @threads I64AtomicRmw16AndU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw16_and_u
	    @threads I64AtomicRmw32AndU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw32_and_u
	    @threads I32AtomicRmwOr { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw_or
	    @threads I64AtomicRmwOr { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw_or
	    @threads I32AtomicRmw8OrU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw8_or_u
	    @threads I32AtomicRmw16OrU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw16_or_u
	    @threads I64AtomicRmw8OrU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw8_or_u
	    @threads I64AtomicRmw16OrU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw16_or_u
	    @threads I64AtomicRmw32OrU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw32_or_u
	    @threads I32AtomicRmwXor { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw_xor
	    @threads I64AtomicRmwXor { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw_xor
	    @threads I32AtomicRmw8XorU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw8_xor_u
	    @threads I32AtomicRmw16XorU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw16_xor_u
	    @threads I64AtomicRmw8XorU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw8_xor_u
	    @threads I64AtomicRmw16XorU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw16_xor_u
	    @threads I64AtomicRmw32XorU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw32_xor_u
	    @threads I32AtomicRmwXchg { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw_xchg
	    @threads I64AtomicRmwXchg { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw_xchg
	    @threads I32AtomicRmw8XchgU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw8_xchg_u
	    @threads I32AtomicRmw16XchgU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw16_xchg_u
	    @threads I64AtomicRmw8XchgU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw8_xchg_u
	    @threads I64AtomicRmw16XchgU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw16_xchg_u
	    @threads I64AtomicRmw32XchgU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw32_xchg_u
	    @threads I32AtomicRmwCmpxchg { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw_cmpxchg
	    @threads I64AtomicRmwCmpxchg { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw_cmpxchg
	    @threads I32AtomicRmw8CmpxchgU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw8_cmpxchg_u
	    @threads I32AtomicRmw16CmpxchgU { _memarg: wasmparser::MemArg } => visit_i32_atomic_rmw16_cmpxchg_u
	    @threads I64AtomicRmw8CmpxchgU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw8_cmpxchg_u
	    @threads I64AtomicRmw16CmpxchgU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw16_cmpxchg_u
	    @threads I64AtomicRmw32CmpxchgU { _memarg: wasmparser::MemArg } => visit_i64_atomic_rmw32_cmpxchg_u

	    // 0xFD operators
	    // SIMD https://webassembly.github.io/simd/core/binary/instructions.html
	    @simd V128Load { _memarg: wasmparser::MemArg } => visit_v128_load
	    @simd V128Load8x8S { _memarg: wasmparser::MemArg } => visit_v128_load8x8_s
	    @simd V128Load8x8U { _memarg: wasmparser::MemArg } => visit_v128_load8x8_u
	    @simd V128Load16x4S { _memarg: wasmparser::MemArg } => visit_v128_load16x4_s
	    @simd V128Load16x4U { _memarg: wasmparser::MemArg } => visit_v128_load16x4_u
	    @simd V128Load32x2S { _memarg: wasmparser::MemArg } => visit_v128_load32x2_s
	    @simd V128Load32x2U { _memarg: wasmparser::MemArg } => visit_v128_load32x2_u
	    @simd V128Load8Splat { _memarg: wasmparser::MemArg } => visit_v128_load8_splat
	    @simd V128Load16Splat { _memarg: wasmparser::MemArg } => visit_v128_load16_splat
	    @simd V128Load32Splat { _memarg: wasmparser::MemArg } => visit_v128_load32_splat
	    @simd V128Load64Splat { _memarg: wasmparser::MemArg } => visit_v128_load64_splat
	    @simd V128Load32Zero { _memarg: wasmparser::MemArg } => visit_v128_load32_zero
	    @simd V128Load64Zero { _memarg: wasmparser::MemArg } => visit_v128_load64_zero
	    @simd V128Store { _memarg: wasmparser::MemArg } => visit_v128_store
	    @simd V128Load8Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_load8_lane
	    @simd V128Load16Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_load16_lane
	    @simd V128Load32Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_load32_lane
	    @simd V128Load64Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_load64_lane
	    @simd V128Store8Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_store8_lane
	    @simd V128Store16Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_store16_lane
	    @simd V128Store32Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_store32_lane
	    @simd V128Store64Lane { _memarg: wasmparser::MemArg, _lane: u8 } => visit_v128_store64_lane
	    @simd V128Const { _value: wasmparser::V128 } => visit_v128_const
	    @simd I8x16Shuffle { _lanes: [u8; 16] } => visit_i8x16_shuffle
	    @simd I8x16ExtractLaneS { _lane: u8 } => visit_i8x16_extract_lane_s
	    @simd I8x16ExtractLaneU { _lane: u8 } => visit_i8x16_extract_lane_u
	    @simd I8x16ReplaceLane { _lane: u8 } => visit_i8x16_replace_lane
	    @simd I16x8ExtractLaneS { _lane: u8 } => visit_i16x8_extract_lane_s
	    @simd I16x8ExtractLaneU { _lane: u8 } => visit_i16x8_extract_lane_u
	    @simd I16x8ReplaceLane { _lane: u8 } => visit_i16x8_replace_lane
	    @simd I32x4ExtractLane { _lane: u8 } => visit_i32x4_extract_lane
	    @simd I32x4ReplaceLane { _lane: u8 } => visit_i32x4_replace_lane
	    @simd I64x2ExtractLane { _lane: u8 } => visit_i64x2_extract_lane
	    @simd I64x2ReplaceLane { _lane: u8 } => visit_i64x2_replace_lane
	    @simd F32x4ExtractLane { _lane: u8 } => visit_f32x4_extract_lane
	    @simd F32x4ReplaceLane { _lane: u8 } => visit_f32x4_replace_lane
	    @simd F64x2ExtractLane { _lane: u8 } => visit_f64x2_extract_lane
	    @simd F64x2ReplaceLane { _lane: u8 } => visit_f64x2_replace_lane
