...
pub struct VMOffsets<P> {
    ...
    /// The number of call_indirect cache slots in the cache tag and
    /// value arrays.
    pub num_call_indirect_cache_slots: u32,
...
impl<P: PtrSize> VMOffsets<P> {
    ...
    pub fn new(ptr: P, module: &Module) -> Self {
        ...
        VMOffsets::from(VMOffsetsFields {
            ...
            num_call_indirect_cache_slots: cast_to_u32(module.num_indirect_call_cache_slots),
        })
    }
        ...
        macro_rules! calculate_sizes {
            ($($name:ident: $desc:tt,)*) => {{
                let VMOffsets {
                    ...
                    num_escaped_funcs: _,
                    num_call_indirect_cache_slots: _,
...
impl<P: PtrSize> From<VMOffsetsFields<P>> for VMOffsets<P> {
    fn from(fields: VMOffsetsFields<P>) -> VMOffsets<P> {
        let mut ret = Self {
            ...
            num_call_indirect_cache_slots: fields.num_call_indirect_cache_slots,
        ...
        fields! {
            ...
            size(call_indirect_cache_values) = cmul(
                ret.num_call_indirect_cache_slots,
                ret.ptr.size(),
            ),
        }
...
impl<P: PtrSize> VMOffsets<P> {
    ...
    #[inline]
    pub fn vmctx_call_indirect_cache_values_begin(&self) -> u32 {
        self.call_indirect_cache_values
    }
