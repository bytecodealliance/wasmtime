...
use wasmtime_environ::null::EXCEPTION_TAG_OFFSET;
...
impl GcCompiler for NullCompiler {
    ...
    fn alloc_exn(
        ...
        let tag_offset = EXCEPTION_TAG_OFFSET;
        ...
        let instance_id_addr = builder
            .ins()
            .iadd_imm(raw_exn_pointer, i64::from(tag_offset));
        write_field_at_addr(
            func_env,
            builder,
        ...
        let tag_addr = builder
            .ins()
            .iadd_imm(raw_exn_pointer, i64::from(tag_offset + 4));
        write_field_at_addr(
            func_env,
            builder,
            WasmStorageType::Val(WasmValType::I32),
