...
pub fn finish_compile(
    ...
    for (i, data) in data.iter().enumerate() {
        // The first data segment gets the requested alignment for the entire
        // section, but everything afterwards is stored adjacently to the first
        // so it has an alignment of 1.
