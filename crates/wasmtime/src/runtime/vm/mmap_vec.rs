...
impl MmapVec {
    ...
    /// mutated.
    ///
    /// This API is allowed to use `mmap` to make a copy-on-write
    /// clone; however, today it does not, in order not to perturb the
    /// file-ownership aspects of Wasmtime's public API.
