...
use wasmtime_environ::{
    CompiledFunctionsIndex, CompiledModuleInfo, EntityIndex, HostPtr, ModuleTypes, ObjectKind,
...
impl Module {
    ...
    pub(crate) fn from_parts(
        ...
        info_and_types: Option<(CompiledModuleInfo, CompiledFunctionsIndex, ModuleTypes)>,
    ) -> Result<Self> {
    ...
    pub(crate) fn from_parts_raw(
        ...
        index: Arc<CompiledFunctionsIndex>,
        serializable: bool,
    ) -> Result<Self> {
