...
use wasmtime_environ::{
    ...
    FunctionLoc, FunctionName, Metadata, Module, ObjectBuilder, PrimaryMap, StackMapInformation,
    TypeIndex, WasmFunctionInfo,
};
...
impl CompiledModule {
    ...
    pub fn wasm_to_native_trampoline(&self, signature: TypeIndex) -> &[u8] {
        let idx = self
