...
use crate::{Engine, Metadata, ModuleVersionStrategy, Precompiled, WasmFeatures, VERSION};
use anyhow::{anyhow, bail, Context, Result};
use object::{File, FileFlags, Object as _, ObjectSection};
use std::str::FromStr;
use wasmtime_environ::obj;
use wasmtime_environ::{ObjectKind, Tunables};
...
impl Metadata<'_> {
    pub(crate) fn check_compatible(mut self, engine: &Engine) -> Result<()> {
