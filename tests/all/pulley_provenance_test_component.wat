(component
  ...
  (core func $host-option (canon lower (func $host-option) (memory (core memory $libc "memory"))))
  (core func $host-result (canon lower (func $host-result) (memory (core memory $libc "memory"))))
  ...
  (func (export "guest-option") (param "x" (option u8)) (result (option u8))
    (canon lift (core func $i "guest-option") (memory (core memory $libc "memory"))))
  (func (export "guest-result") (param "x" $result) (result $result)
    (canon lift (core func $i "guest-result") (memory (core memory $libc "memory"))))
  (func (export "guest-string") (param "x" string) (result string)
    (canon lift (core func $i "guest-string") (memory (core memory $libc "memory"))
                (realloc (core func $libc "realloc"))))
  (func (export "guest-list") (param "x" (list string)) (result (list string))
    (canon lift (core func $i "guest-list") (memory (core memory $libc "memory"))
                (realloc (core func $libc "realloc"))))
  (func (export "resource-intrinsics")
