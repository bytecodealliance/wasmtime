...
;; @0040                               v5 = load.i64 notrap aligned v0+72
;; @0040                               v6 = icmp ugt v4, v5
;; @0040                               trapnz v6, heap_oob
;; @0040                               v7 = load.i64 notrap aligned can_move checked v0+64
;; @0040                               v8 = iadd v7, v4
...
;; @004c                               v5 = load.i64 notrap aligned v0+72
;; @004c                               v6 = icmp ugt v4, v5
;; @004c                               trapnz v6, heap_oob
;; @004c                               v7 = load.i64 notrap aligned can_move checked v0+64
;; @004c                               v8 = iadd v7, v4
