...
;;     region3 = 112 "VMMemoryImport+0x0"
;;     region4 = 193 "VMMemoryDefinition+0x0"
;;     region5 = 213 "VMMemoryDefinition+0x8"
;;     region6 = 248 "DefinedMemory(StaticModuleIndex(1), DefinedMemoryIndex(0))"
;;     gv0 = vmctx
;;     gv1 = load.i64 notrap aligned readonly can_move region0 gv0+8
;;     gv2 = load.i64 notrap aligned region1 gv1+24
...
;;     region6 = 112 "VMMemoryImport+0x0"
;;     region7 = 193 "VMMemoryDefinition+0x0"
;;     region8 = 213 "VMMemoryDefinition+0x8"
;;     region9 = 39 "DefinedMemory(StaticModuleIndex(0), DefinedMemoryIndex(0))"
;;     region10 = 248 "DefinedMemory(StaticModuleIndex(1), DefinedMemoryIndex(0))"
;;     gv0 = vmctx
;;     gv1 = load.i64 notrap aligned readonly can_move region0 gv0+8
;;     gv2 = load.i64 notrap aligned region1 gv1+24
