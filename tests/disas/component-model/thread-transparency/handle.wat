...
;; A handle anywhere in either signature is makes the adapter opaque.
...
(component
  (component $A
    ...
    (func (export "f") (param "h" (own $t')) (result u32)
  ...
  (component $B
    ...
    (import "f" (func $f (param "h" (own $t)) (result u32)))
...
;;     sig3 = (i64 vmctx, i64, i32, i32, i32) -> i32 tail
;;     sig4 = (i64 vmctx, i64, i32) -> i32 tail
;;     fn0 = colocated u2:0 sig0
;;     fn1 = colocated u0:0 sig4
;;     stack_limit = gv2
;;
...
;;
;;                                 block6:
;; @0114                               v3 = load.i64 notrap aligned readonly can_move region2 v0+72
;;                                     v10 = load.i64 notrap aligned readonly can_move region3 v3+264
...
;;                                     v22 = load.i64 notrap aligned readonly can_move region3 v3+240
;;                                     v23 = load.i32 notrap aligned region13 v22
;;                                     store notrap aligned region13 v9, v22  ; v9 = 0
;;                                     v29 = load.i64 notrap aligned readonly can_move region14 v3+152
;;                                     v28 = load.i64 notrap aligned readonly can_move region2 v3+168
;; @0111                               v2 = iconst.i32 1234
;;                                     v26 = iconst.i32 2
;;                                     try_call_indirect v29(v28, v3, v2, v26, v9), sig3, block11(ret0), [ context v3, default: block8(exn0) ]  ; v2 = 1234, v26 = 2, v9 = 0
;;
;;                                 block11(v6: i32):
;;                                     store.i32 notrap aligned region13 v23, v22
;;                                     jump block17
;;
;;                                 block17:
;;                                     jump block18
...
;;
;;                                 block12:
;;                                     v39 = load.i64 notrap aligned region5 v16+136
;;                                     v40 = icmp eq v39, v15
;;                                     brif v40, block13, block14
;;
;;                                 block13:
;;                                     v41 = load.i64 notrap aligned region6 v15
;;                                     store notrap aligned region5 v41, v16+136
;;                                     v42 = load.i32 notrap aligned region10 v15+16
;;                                     store notrap aligned region9 v42, v16+128
;;                                     v43 = load.i32 notrap aligned region12 v15+20
;;                                     store notrap aligned region11 v43, v16+132
;;                                     jump block15
;;
;;                                 block14:
;;                                     v47 = load.i64 notrap aligned readonly can_move region14 v3+184
;;                                     v36 = load.i64 notrap aligned readonly can_move region2 v3+200
;;                                     try_call_indirect v47(v36, v3), sig1, block16, [ context v3, default: block8(exn0) ]
;;
;;                                 block16:
;;                                     jump block15
;;
