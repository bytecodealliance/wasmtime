...
;; An `async` function type is disqualifying even when both sides of the adapter
;; are lifted and lowered synchronously, so the `{enter,exit}-sync-call` calls
;; are kept.
...
;;                                     v11 = iconst.i32 1
;;                                     store notrap aligned region7 v11, v14+8  ; v11 = 1
;;                                     store notrap aligned region8 v11, v14+12  ; v11 = 1
