...
;;     gv2 = load.i64 notrap aligned readonly can_move checked gv0+80
;;
;;                                 block0(v0: i64, v1: i64, v2: i8x16):
;; @003f                               v3 = iconst.i32 0
;; @0045                               v4 = icmp eq v2, v2
;; @0047                               v5 = uextend.i64 v3  ; v3 = 0
;; @0047                               v6 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0047                               v7 = iadd v6, v5
...
;; @0056                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0056                               v9 = iadd v8, v7
...
;; @0065                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0065                               v9 = iadd v8, v7
...
;; @0075                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0075                               v9 = iadd v8, v7
...
;; @0084                               v6 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0084                               v7 = iadd v6, v5
...
;; @0093                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0093                               v9 = iadd v8, v7
...
;; @00a2                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @00a2                               v9 = iadd v8, v7
...
;; @00b2                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @00b2                               v9 = iadd v8, v7
...
;; @00c1                               v6 = load.i64 notrap aligned readonly can_move checked v0+80
;; @00c1                               v7 = iadd v6, v5
...
;; @00d0                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @00d0                               v9 = iadd v8, v7
...
;; @00df                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @00df                               v9 = iadd v8, v7
...
;; @00ef                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @00ef                               v9 = iadd v8, v7
...
;; @00fe                               v6 = load.i64 notrap aligned readonly can_move checked v0+80
;; @00fe                               v7 = iadd v6, v5
...
;; @010d                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @010d                               v9 = iadd v8, v7
...
;; @011c                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @011c                               v9 = iadd v8, v7
...
;; @012b                               v6 = load.i64 notrap aligned readonly can_move checked v0+80
;; @012b                               v7 = iadd v6, v5
...
;; @013a                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @013a                               v9 = iadd v8, v7
...
;; @0149                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0149                               v9 = iadd v8, v7
...
;; @0159                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0159                               v9 = iadd v8, v7
...
;; @0168                               v6 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0168                               v7 = iadd v6, v5
...
;; @0177                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0177                               v9 = iadd v8, v7
...
;; @0186                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0186                               v9 = iadd v8, v7
...
;; @0195                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0195                               v9 = iadd v8, v7
...
;; @01a4                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @01a4                               v9 = iadd v8, v7
...
;; @01b3                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @01b3                               v9 = iadd v8, v7
...
;; @01c2                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @01c2                               v9 = iadd v8, v7
...
;; @01d1                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @01d1                               v9 = iadd v8, v7
...
;; @01e0                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @01e0                               v9 = iadd v8, v7
...
;; @01ef                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @01ef                               v9 = iadd v8, v7
...
;; @01fe                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @01fe                               v9 = iadd v8, v7
...
;; @020d                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @020d                               v9 = iadd v8, v7
...
;; @021c                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @021c                               v9 = iadd v8, v7
...
;; @022b                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @022b                               v9 = iadd v8, v7
...
;; @023a                               v8 = load.i64 notrap aligned readonly can_move checked v0+80
;; @023a                               v9 = iadd v8, v7
