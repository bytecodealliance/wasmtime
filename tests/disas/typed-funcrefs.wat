...
;;     gv0 = vmctx
;;     gv1 = load.i64 notrap aligned readonly can_move gv0+56
;;     sig0 = (i64 vmctx, i32, i64) -> i64 tail
;;     sig1 = (i64 vmctx, i64, i32, i32, i32, i32) -> i32 tail
;;     fn0 = colocated u1:9 sig0
;;
;;                                 block0(v0: i64, v1: i64, v2: i32, v3: i32, v4: i32, v5: i32):
;; @0048                               v12 = load.i64 notrap aligned readonly can_move v0+56
;;                                     v68 = iconst.i64 8
...
;;
;;                                 block0(v0: i64, v1: i64, v2: i32, v3: i32, v4: i32, v5: i32):
;; @0075                               v12 = load.i64 notrap aligned readonly can_move v0+56
;;                                     v68 = iconst.i64 8
...
;;
;;                                 block0(v0: i64, v1: i64, v2: i32, v3: i32, v4: i32, v5: i32):
;; @009e                               v9 = load.i64 notrap aligned table v0+80
...
;; @00af                               v15 = load.i64 notrap aligned table v0+96
