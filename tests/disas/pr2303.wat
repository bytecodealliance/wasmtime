...
;; @003a                               v6 = load.i64 notrap aligned readonly can_move checked v0+64
;; @003a                               v7 = iadd v6, v5
;; @003a                               v8 = load.i8x16 little heap v7
;; @003e                               v9 = iconst.i32 16
;; @0040                               v10 = uextend.i64 v9  ; v9 = 16
;; @0040                               v11 = load.i64 notrap aligned readonly can_move checked v0+64
...
;; @004d                               v21 = load.i64 notrap aligned readonly can_move checked v0+64
...
;; @0057                               v32 = load.i64 notrap aligned readonly can_move checked v0+64
...
;; @005f                               v40 = load.i64 notrap aligned readonly can_move checked v0+64
