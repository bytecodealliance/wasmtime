...
;;     region2 = 67108944 "VMStoreContext+0x50"
;;     region3 = 67108936 "VMStoreContext+0x48"
...
;;     store notrap aligned region2 v7, v6+80
;;     v8 = get_stack_pointer.i64 
;;     store notrap aligned region3 v8, v6+72
;;     v9 = get_exception_handler_address.i64 block1, 0
;;     store notrap aligned region4 v9, v6+88
...
;; block3:
;;     v13 = iconst.i64 1
;;     store notrap aligned region5 v13, v6+144  ; v13 = 1
;;     v14 = iconst.i8 0
;;     return v14  ; v14 = 0
;; }
