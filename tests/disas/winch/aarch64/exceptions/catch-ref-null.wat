...
;;       ╰─╼ exception handler: tag=0, context at [SP+0x8], handler=0x1cc
;;   48: ldur    x9, [x28, #8]
;;       ldur    x16, [x9, #0x20]
;;       ldur    w1, [x16]
;;       adds    w1, w1, #7
...
;;       ╰─╼ exception handler: tag=0, context at [SP+0x18], handler=0x1cc
;;   d0: add     x28, x28, #8
;;       mov     sp, x28
;;       ldur    x9, [x28, #0x10]
;;       ldur    w0, [x28]
...
;;       ╰─╼ exception handler: tag=0, context at [SP+0x28], handler=0x1cc
;;  178: add     x28, x28, #0x14
;;       mov     sp, x28
;;       ldur    x9, [x28, #0x14]
;;       ldur    w1, [x28]
;;       add     x28, x28, #4
