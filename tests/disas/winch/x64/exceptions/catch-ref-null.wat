...
;;       ╰─╼ exception handler: tag=0, context at [SP+0x8], handler=0x177
;;       movq    8(%rsp), %r14
;;       movq    0x20(%r14), %r11
;;       movl    (%r11), %ecx
;;       addl    $7, %ecx
...
;;       ╰─╼ exception handler: tag=0, context at [SP+0x18], handler=0x177
;;       addq    $8, %rsp
;;       movq    0x10(%rsp), %r14
;;       movl    (%rsp), %eax
;;       addq    $4, %rsp
...
;;       ╰─╼ exception handler: tag=0, context at [SP+0x28], handler=0x177
;;       addq    $0x14, %rsp
;;       movq    0x14(%rsp), %r14
;;       movl    (%rsp), %ecx
;;       addq    $4, %rsp
