...
;; @0054                               v7 = load.i64 notrap aligned v0+88
;;                                     v49 = iconst.i64 2
;; @0054                               v8 = ishl v6, v49  ; v49 = 2
;; @0054                               v9 = iadd v7, v8
...
;;
;;                                 block2:
;; @0054                               v17 = load.i64 notrap aligned v0+48
...
;;
;;                                 block4:
;; @0054                               v22 = load.i64 notrap aligned readonly v0+32
;; @0054                               v23 = load.i64 notrap aligned readonly v0+40
...
;;                                     v50 = iconst.i64 1
;; @0054                               v32 = iadd v31, v50  ; v50 = 1
;; @0054                               v34 = load.i64 notrap aligned readonly v0+32
;; @0054                               v35 = load.i64 notrap aligned readonly v0+40
...
;;                                     v51 = iconst.i64 8
;; @0054                               v43 = iadd.i64 v18, v51  ; v51 = 8
;; @0054                               store notrap aligned v43, v17
;; @0054                               jump block5
;;
;;                                 block3 cold:
;; @0054                               v45 = load.i64 notrap aligned readonly v0+72
;; @0054                               v46 = load.i64 notrap aligned readonly v45+208
;; @0054                               v47 = call_indirect sig0, v46(v0, v14)
;; @0054                               jump block5
;;
;;                                 block5:
;; @0056                               jump block1
...
;; @005b                               v7 = load.i64 notrap aligned v0+88
;;                                     v49 = iconst.i64 2
;; @005b                               v8 = ishl v6, v49  ; v49 = 2
;; @005b                               v9 = iadd v7, v8
...
;;
;;                                 block2:
;; @005b                               v17 = load.i64 notrap aligned v0+48
...
;;
;;                                 block4:
;; @005b                               v22 = load.i64 notrap aligned readonly v0+32
;; @005b                               v23 = load.i64 notrap aligned readonly v0+40
...
;;                                     v50 = iconst.i64 1
;; @005b                               v32 = iadd v31, v50  ; v50 = 1
;; @005b                               v34 = load.i64 notrap aligned readonly v0+32
;; @005b                               v35 = load.i64 notrap aligned readonly v0+40
...
;;                                     v51 = iconst.i64 8
;; @005b                               v43 = iadd.i64 v18, v51  ; v51 = 8
;; @005b                               store notrap aligned v43, v17
;; @005b                               jump block5
;;
;;                                 block3 cold:
;; @005b                               v45 = load.i64 notrap aligned readonly v0+72
;; @005b                               v46 = load.i64 notrap aligned readonly v45+208
;; @005b                               v47 = call_indirect sig0, v46(v0, v14)
;; @005b                               jump block5
;;
;;                                 block5:
;; @005d                               jump block1
