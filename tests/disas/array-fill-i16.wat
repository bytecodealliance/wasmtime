...
;;                                     v52 = ishl v13, v15  ; v15 = 1
;; @0031                               v28 = iadd v24, v52
;;                                     v56 = ishl v14, v15  ; v15 = 1
;; @0031                               v36 = uadd_overflow_trap v28, v56, user2
...
;; @0031                               v38 = iadd v28, v56
;; @0031                               brif v40, block3, block2(v28)
;;
;;                                 block2(v41: i64):
;; @0031                               istore16.i32 user2 little region0 v4, v41
;;                                     v59 = iconst.i64 2
;;                                     v60 = iadd v41, v59  ; v59 = 2
;; @0031                               v44 = icmp eq v60, v38
;; @0031                               brif v44, block3, block2(v60)
;;
;;                                 block3:
;; @0034                               jump block1
;;
...
;;                                     v46 = ishl v13, v15  ; v15 = 1
;; @003f                               v28 = iadd v24, v46
;;                                     v50 = ishl v14, v15  ; v15 = 1
;; @003f                               v36 = uadd_overflow_trap v28, v50, user2
;; @003f                               v35 = iadd v7, v34
;; @003f                               v37 = icmp ugt v36, v35
;; @003f                               trapnz v37, user2
;; @003b                               v5 = iconst.i32 0
;; @003f                               call fn0(v0, v28, v5, v50)  ; v5 = 0
;; @0042                               jump block1
;;
;;                                 block1:
;; @0042                               return
...
;; @005d                               v47 = load.i64 notrap aligned readonly can_move v0+8
;; @005d                               v7 = load.i64 notrap aligned readonly can_move v47+32
...
;; @005d                               v34 = load.i64 notrap aligned v47+40
;; @005d                               v23 = iconst.i64 20
;; @005d                               v24 = iadd v8, v23  ; v23 = 20
;; @005d                               v15 = iconst.i64 1
;;                                     v52 = ishl v13, v15  ; v15 = 1
;; @005d                               v28 = iadd v24, v52
;;                                     v56 = ishl v14, v15  ; v15 = 1
;; @005d                               v36 = uadd_overflow_trap v28, v56, user2
;; @005d                               v35 = iadd v7, v34
;; @005d                               v37 = icmp ugt v36, v35
;; @005d                               trapnz v37, user2
;;                                     v49 = iconst.i64 0
;; @005d                               v40 = icmp eq v14, v49  ; v49 = 0
;; @0057                               v5 = iconst.i32 0xdead
;; @005d                               v26 = iconst.i64 2
;; @005d                               v38 = iadd v28, v56
;; @005d                               brif v40, block3, block2(v28)
;;
;;                                 block2(v41: i64):
;;                                     v59 = iconst.i32 0xdead
;; @005d                               istore16 user2 little region0 v59, v41  ; v59 = 0xdead
;;                                     v60 = iconst.i64 2
;;                                     v61 = iadd v41, v60  ; v60 = 2
;; @005d                               v44 = icmp eq v61, v38
;; @005d                               brif v44, block3, block2(v61)
;;
;;                                 block3:
;; @0060                               jump block1
;;
