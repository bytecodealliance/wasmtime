...
;; @002b                               v5 = iconst.i32 2
;; @002b                               v6 = icmp uge v2, v5  ; v5 = 2
;; @002b                               v11 = iconst.i64 0
;; @002b                               v8 = load.i64 notrap aligned readonly v0+88
;; @002b                               v7 = uextend.i64 v2
;;                                     v29 = iconst.i64 3
;; @002b                               v9 = ishl v7, v29  ; v29 = 3
;; @002b                               v10 = iadd v8, v9
;; @002b                               v12 = select_spectre_guard v6, v11, v10  ; v11 = 0
;;                                     v30 = iconst.i64 -2
...
;;
;;                                 block2:
;; @002b                               v13 = load.i64 table_oob aligned table v12
;;                                     v31 = iconst.i64 -2
;;                                     v32 = band v13, v31  ; v31 = -2
;; @002b                               brif v13, block5(v32), block4
;;
;;                                 block4 cold:
;;                                     v33 = iconst.i32 0
;; @002b                               v18 = call fn0(v0, v33, v2)  ; v33 = 0
;; @002b                               jump block5(v18)
;;
;;                                 block5(v15: i64):
;; @002b                               v22 = load.i32 icall_null aligned readonly v15+16
...
;;
;;                                 block7:
;; @002b                               v24 = load.i64 notrap aligned readonly v15+8
;; @002b                               v25 = load.i64 notrap aligned readonly v15+24
...
;; @0038                               v7 = load.i64 notrap aligned readonly v0+88
;;                                     v37 = iconst.i64 8
;; @0038                               v9 = iadd v7, v37  ; v37 = 8
;;                                     v28 = iconst.i64 -2
...
;;
;;                                 block2:
;;                                     v38 = iadd.i64 v7, v37  ; v37 = 8
;; @0038                               v12 = load.i64 table_oob aligned table v38
;;                                     v39 = iconst.i64 -2
...
;;
;;                                 block5(v14: i64):
;; @0038                               v21 = load.i32 icall_null aligned readonly v14+16
...
;;
;;                                 block7:
;; @0038                               v23 = load.i64 notrap aligned readonly v14+8
;; @0038                               v24 = load.i64 notrap aligned readonly v14+24
