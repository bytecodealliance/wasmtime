...
;;                                     v46 = iconst.i64 0
;; @0025                               trapnz v46, alloc_too_large  ; v46 = 0
;; @0025                               v6 = iconst.i32 24
;; @0025                               v12 = uadd_overflow_trap v6, v6, alloc_too_large  ; v6 = 24, v6 = 24
...
;; @0025                               v23 = uadd_overflow_trap v21, v22, user65535  ; v22 = 16
;; @0025                               v24 = uextend.i64 v12
;; @0025                               v25 = uadd_overflow_trap v21, v24, user65535
;; @0025                               v20 = load.i64 notrap aligned readonly v0+48
;; @0025                               v26 = icmp ule v25, v20
;; @0025                               trapz v26, user65535
