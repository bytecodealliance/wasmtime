...
;;                                     v63 = iconst.i64 0
;; @0025                               trapnz v63, user18  ; v63 = 0
;; @0025                               v7 = iconst.i32 16
;;                                     v64 = iconst.i32 24
;; @0025                               v12 = uadd_overflow_trap v7, v64, user18  ; v7 = 16, v64 = 24
...
;;                                     v65 = iconst.i32 7
;; @0025                               v21 = uadd_overflow_trap v18, v65, user18  ; v65 = 7
;;                                     v72 = iconst.i32 -8
;; @0025                               v23 = band v21, v72  ; v72 = -8
...
;;                                     v73 = bor.i32 v12, v34  ; v34 = -1476395008
;; @0025                               v31 = load.i64 notrap aligned readonly can_move v49+24
;;                                     v105 = band.i32 v21, v72  ; v72 = -8
;;                                     v106 = uextend.i64 v105
;; @0025                               v33 = iadd v31, v106
;; @0025                               store notrap aligned v73, v33
...
;;                                     v76 = iconst.i64 16
;;                                     v82 = iadd v33, v76  ; v76 = 16
;; @0025                               store.i64 notrap aligned little v2, v82
;;                                     v55 = iconst.i64 24
;;                                     v89 = iadd v33, v55  ; v55 = 24
;; @0025                               store.i64 notrap aligned little v3, v89
;;                                     v48 = iconst.i64 32
;;                                     v96 = iadd v33, v48  ; v48 = 32
;; @0025                               store.i64 notrap aligned little v4, v96
;; @0029                               jump block1
;;
;;                                 block3 cold:
