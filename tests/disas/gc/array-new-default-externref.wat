...
;;                                     v88 = iconst.i64 2
;;                                     v89 = ishl v4, v88  ; v88 = 2
;; @001f                               v7 = iconst.i64 32
;; @001f                               v8 = ushr v89, v7  ; v7 = 32
...
;;                                 block2:
;;                                     v104 = iconst.i32 15
;;                                     v105 = iadd.i32 v10, v104  ; v104 = 15
;;                                     v108 = iconst.i32 -16
;;                                     v109 = band v105, v108  ; v108 = -16
;;                                     v111 = iadd.i32 v12, v109
;; @001f                               store notrap aligned region3 v111, v11
...
;; @001f                               v36 = iadd v129, v19
;; @001f                               store user2 region8 v127, v36  ; v127 = -1476394994
;;                                     v130 = load.i64 notrap aligned readonly can_move region5 v0+40
;;                                     v131 = load.i32 notrap aligned readonly can_move region6 v130
;; @001f                               store user2 region8 v131, v36+4
;; @001f                               store user2 region8 v109, v36+8
...
;;                                 block5(v84: i64):
;;                                     v134 = iconst.i32 0
;; @001f                               store user2 little region8 v134, v84  ; v134 = 0
;;                                     v135 = iconst.i64 4
;;                                     v136 = iadd v84, v135  ; v135 = 4
;; @001f                               v87 = icmp eq v136, v81
;; @001f                               brif v87, block6, block5(v136)
;;
;;                                 block6:
;; @0022                               jump block1
;;
