...
;; @0023                               trapz v2, null_reference
;; @0023                               v9 = uextend.i64 v2
;; @0023                               v10 = iconst.i64 16
;; @0023                               v11 = uadd_overflow_trap v9, v10, user65535  ; v10 = 16
;;                                     v30 = iconst.i64 24
;; @0023                               v13 = uadd_overflow_trap v9, v30, user65535  ; v30 = 24
;; @0023                               v8 = load.i64 notrap aligned readonly v0+48
;; @0023                               v14 = icmp ule v13, v8
;; @0023                               trapz v14, user65535
;; @0023                               v7 = load.i64 notrap aligned readonly v0+40
;; @0023                               v15 = iadd v7, v11
;; @0023                               v16 = load.f32 notrap aligned little v15
;; @0029                               trapz v2, null_reference
;; @0029                               v22 = iconst.i64 20
;; @0029                               v23 = uadd_overflow_trap v9, v22, user65535  ; v22 = 20
;; @0029                               trapz v14, user65535
