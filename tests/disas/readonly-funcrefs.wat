...
;; @0031                               v11 = load.i64 user6 aligned region0 v10
;; @0031                               v12 = iconst.i64 -2
;; @0031                               v13 = band v11, v12  ; v12 = -2
;; @0031                               brif v11, block3(v13), block2
;;
;;                                 block2 cold:
;; @0031                               v15 = iconst.i32 0
;; @0031                               v18 = call fn0(v0, v15, v5)  ; v15 = 0
;; @0031                               jump block3(v18)
;;
;;                                 block3(v14: i64):
;; @0031                               v22 = load.i32 user7 aligned readonly v14+16
;; @0031                               v20 = load.i64 notrap aligned readonly can_move v0+40
;; @0031                               v21 = load.i32 notrap aligned readonly can_move v20
;; @0031                               v23 = icmp eq v22, v21
;; @0031                               trapz v23, user8
;; @0031                               v24 = load.i64 notrap aligned readonly v14+8
;; @0031                               v25 = load.i64 notrap aligned readonly v14+24
