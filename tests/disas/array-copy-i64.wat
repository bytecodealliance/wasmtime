...
;;                                     v80 = iconst.i64 3
;;                                     v81 = ishl v14, v80  ; v80 = 3
;; @002b                               v29 = iadd v25, v81
;;                                     v85 = ishl v15, v80  ; v80 = 3
;; @002b                               v62 = uadd_overflow_trap v29, v85, user2
;; @002b                               v61 = iadd v8, v60
;; @002b                               v63 = icmp ugt v62, v61
;; @002b                               trapnz v63, user2
;; @002b                               v48 = iadd v32, v24  ; v24 = 24
;;                                     v83 = ishl v37, v80  ; v80 = 3
;; @002b                               v52 = iadd v48, v83
;; @002b                               v68 = uadd_overflow_trap v52, v85, user2
;; @002b                               v69 = icmp ugt v68, v61
;; @002b                               trapnz v69, user2
;; @002b                               call fn0(v0, v29, v52, v85)
;; @002f                               jump block1
;;
;;                                 block1:
;; @002f                               return
