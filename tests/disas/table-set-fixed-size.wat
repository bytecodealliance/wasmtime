...
;; @0056                               v7 = load.i64 notrap aligned v0+88
;;                                     v69 = iconst.i64 3
;; @0056                               v8 = ishl v6, v69  ; v69 = 3
;; @0056                               v9 = iadd v7, v8
...
;;
;;                                 block2:
;; @0056                               v17 = load.i64 notrap aligned readonly v0+32
;; @0056                               v18 = load.i64 notrap aligned readonly v0+40
...
;;                                     v70 = iconst.i64 1
;; @0056                               v27 = iadd v26, v70  ; v70 = 1
;; @0056                               v29 = load.i64 notrap aligned readonly v0+32
;; @0056                               v30 = load.i64 notrap aligned readonly v0+40
...
;; @0056                               store.i64 table_oob aligned table v11, v39
;; @0056                               v40 = is_null.r64 v14
;; @0056                               brif v40, block7, block4
;;
;;                                 block4:
;; @0056                               v42 = load.i64 notrap aligned readonly v0+32
;; @0056                               v43 = load.i64 notrap aligned readonly v0+40
...
;;                                     v71 = iconst.i64 -1
;; @0056                               v52 = iadd v51, v71  ; v71 = -1
;;                                     v72 = iconst.i64 0
;; @0056                               v53 = icmp eq v52, v72  ; v72 = 0
;; @0056                               brif v53, block5, block6
;;
;;                                 block5 cold:
;; @0056                               v55 = load.i64 notrap aligned readonly v0+72
;; @0056                               v56 = load.i64 notrap aligned readonly v55+200
;; @0056                               v57 = bitcast.i64 v14
;; @0056                               call_indirect sig0, v56(v0, v57)
;; @0056                               jump block7
;;
;;                                 block6:
;; @0056                               v59 = load.i64 notrap aligned readonly v0+32
;; @0056                               v60 = load.i64 notrap aligned readonly v0+40
;; @0056                               v61 = bitcast.i64 v14
;; @0056                               v62 = iconst.i64 8
;; @0056                               v63 = uadd_overflow_trap v61, v62, user65535  ; v62 = 8
;; @0056                               v64 = iconst.i64 8
;; @0056                               v65 = uadd_overflow_trap v63, v64, user65535  ; v64 = 8
;; @0056                               v66 = icmp ult v65, v60
;; @0056                               brif v66, block15, block14
;;
;;                                 block14 cold:
;; @0056                               trap user65535
;;
;;                                 block15:
;; @0056                               v67 = iadd.i64 v59, v63
;; @0056                               store.i64 notrap aligned v52, v67
;; @0056                               jump block7
;;
;;                                 block7:
;; @0058                               jump block1
...
;; @005f                               v7 = load.i64 notrap aligned v0+88
;;                                     v69 = iconst.i64 3
;; @005f                               v8 = ishl v6, v69  ; v69 = 3
;; @005f                               v9 = iadd v7, v8
...
;;
;;                                 block2:
;; @005f                               v17 = load.i64 notrap aligned readonly v0+32
;; @005f                               v18 = load.i64 notrap aligned readonly v0+40
...
;;                                     v70 = iconst.i64 1
;; @005f                               v27 = iadd v26, v70  ; v70 = 1
;; @005f                               v29 = load.i64 notrap aligned readonly v0+32
;; @005f                               v30 = load.i64 notrap aligned readonly v0+40
...
;; @005f                               store.i64 table_oob aligned table v11, v39
;; @005f                               v40 = is_null.r64 v14
;; @005f                               brif v40, block7, block4
;;
;;                                 block4:
;; @005f                               v42 = load.i64 notrap aligned readonly v0+32
;; @005f                               v43 = load.i64 notrap aligned readonly v0+40
...
;;                                     v71 = iconst.i64 -1
;; @005f                               v52 = iadd v51, v71  ; v71 = -1
;;                                     v72 = iconst.i64 0
;; @005f                               v53 = icmp eq v52, v72  ; v72 = 0
;; @005f                               brif v53, block5, block6
;;
;;                                 block5 cold:
;; @005f                               v55 = load.i64 notrap aligned readonly v0+72
;; @005f                               v56 = load.i64 notrap aligned readonly v55+200
;; @005f                               v57 = bitcast.i64 v14
;; @005f                               call_indirect sig0, v56(v0, v57)
;; @005f                               jump block7
;;
;;                                 block6:
;; @005f                               v59 = load.i64 notrap aligned readonly v0+32
;; @005f                               v60 = load.i64 notrap aligned readonly v0+40
;; @005f                               v61 = bitcast.i64 v14
;; @005f                               v62 = iconst.i64 8
;; @005f                               v63 = uadd_overflow_trap v61, v62, user65535  ; v62 = 8
;; @005f                               v64 = iconst.i64 8
;; @005f                               v65 = uadd_overflow_trap v63, v64, user65535  ; v64 = 8
;; @005f                               v66 = icmp ult v65, v60
;; @005f                               brif v66, block15, block14
;;
;;                                 block14 cold:
;; @005f                               trap user65535
;;
;;                                 block15:
;; @005f                               v67 = iadd.i64 v59, v63
;; @005f                               store.i64 notrap aligned v52, v67
;; @005f                               jump block7
;;
;;                                 block7:
;; @0061                               jump block1
