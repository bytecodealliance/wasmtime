...
;; @0031                               v47 = load.i64 notrap aligned readonly can_move v0+8
;; @0031                               v7 = load.i64 notrap aligned readonly can_move v47+32
...
;; @0031                               v34 = load.i64 notrap aligned v47+40
;; @0031                               v23 = iconst.i64 24
;; @0031                               v24 = iadd v8, v23  ; v23 = 24
;;                                     v51 = iconst.i64 3
;;                                     v52 = ishl v13, v51  ; v51 = 3
;; @0031                               v28 = iadd v24, v52
;;                                     v54 = ishl v14, v51  ; v51 = 3
;; @0031                               v36 = uadd_overflow_trap v28, v54, user2
;; @0031                               v35 = iadd v7, v34
;; @0031                               v37 = icmp ugt v36, v35
;; @0031                               trapnz v37, user2
;;                                     v49 = iconst.i64 0
;; @0031                               v40 = icmp eq v14, v49  ; v49 = 0
;; @0031                               v26 = iconst.i64 8
;; @0031                               v38 = iadd v28, v54
;; @0031                               brif v40, block3, block2(v28)
;;
;;                                 block2(v41: i64):
;; @0031                               store.i64 user2 little region0 v4, v41
;;                                     v56 = iconst.i64 8
;;                                     v57 = iadd v41, v56  ; v56 = 8
;; @0031                               v44 = icmp eq v57, v38
;; @0031                               brif v44, block3, block2(v57)
;;
;;                                 block3:
;; @0034                               jump block1
;;
...
;; @003f                               v41 = load.i64 notrap aligned readonly can_move v0+8
;; @003f                               v7 = load.i64 notrap aligned readonly can_move v41+32
...
;; @003f                               v34 = load.i64 notrap aligned v41+40
...
;; @003f                               v36 = uadd_overflow_trap v28, v47, user2
;; @003f                               v35 = iadd v7, v34
;; @003f                               v37 = icmp ugt v36, v35
;; @003f                               trapnz v37, user2
;; @003f                               v38 = iconst.i32 0
;; @003f                               call fn0(v0, v28, v38, v47)  ; v38 = 0
;; @0042                               jump block1
;;
;;                                 block1:
;; @0042                               return
...
;; @004d                               v41 = load.i64 notrap aligned readonly can_move v0+8
;; @004d                               v7 = load.i64 notrap aligned readonly can_move v41+32
...
;; @004d                               v34 = load.i64 notrap aligned v41+40
;; @004d                               v23 = iconst.i64 24
;; @004d                               v24 = iadd v8, v23  ; v23 = 24
;;                                     v45 = iconst.i64 3
;;                                     v46 = ishl v13, v45  ; v45 = 3
;; @004d                               v28 = iadd v24, v46
;;                                     v48 = ishl v14, v45  ; v45 = 3
;; @004d                               v36 = uadd_overflow_trap v28, v48, user2
;; @004d                               v35 = iadd v7, v34
;; @004d                               v37 = icmp ugt v36, v35
;; @004d                               trapnz v37, user2
;; @004d                               v38 = iconst.i32 255
;; @004d                               call fn0(v0, v28, v38, v48)  ; v38 = 255
;; @0050                               jump block1
;;
;;                                 block1:
;; @0050                               return
...
;; @005b                               v47 = load.i64 notrap aligned readonly can_move v0+8
;; @005b                               v7 = load.i64 notrap aligned readonly can_move v47+32
...
;; @005b                               v34 = load.i64 notrap aligned v47+40
;; @005b                               v23 = iconst.i64 24
;; @005b                               v24 = iadd v8, v23  ; v23 = 24
;;                                     v51 = iconst.i64 3
;;                                     v52 = ishl v13, v51  ; v51 = 3
;; @005b                               v28 = iadd v24, v52
;;                                     v54 = ishl v14, v51  ; v51 = 3
;; @005b                               v36 = uadd_overflow_trap v28, v54, user2
;; @005b                               v35 = iadd v7, v34
;; @005b                               v37 = icmp ugt v36, v35
;; @005b                               trapnz v37, user2
;;                                     v49 = iconst.i64 0
;; @005b                               v40 = icmp eq v14, v49  ; v49 = 0
;; @0057                               v5 = iconst.i64 1
;; @005b                               v26 = iconst.i64 8
;; @005b                               v38 = iadd v28, v54
;; @005b                               brif v40, block3, block2(v28)
;;
;;                                 block2(v41: i64):
;;                                     v56 = iconst.i64 1
;; @005b                               store user2 little region0 v56, v41  ; v56 = 1
;;                                     v57 = iconst.i64 8
;;                                     v58 = iadd v41, v57  ; v57 = 8
;; @005b                               v44 = icmp eq v58, v38
;; @005b                               brif v44, block3, block2(v58)
;;
;;                                 block3:
;; @005e                               jump block1
;;
