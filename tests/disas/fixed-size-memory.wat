...
;; @0041                               v4 = ireduce.i8 v3
;; @0041                               v5 = uextend.i64 v2
;; @0041                               v6 = iconst.i64 0x0001_0000
;; @0041                               v7 = icmp uge v5, v6  ; v6 = 0x0001_0000
;; @0041                               trapnz v7, heap_oob
;; @0041                               v8 = global_value.i64 gv5
;; @0041                               v9 = iadd v8, v5
;; @0041                               store little heap v4, v9
;; @0044                               jump block1
;;
;;                                 block1:
;; @0044                               return
