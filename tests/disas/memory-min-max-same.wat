...
;;     region3 = 59 "VMFunctionImport+0x8"
;;     region4 = 193 "VMMemoryDefinition+0x0"
;;     region5 = 213 "VMMemoryDefinition+0x8"
;;     region6 = 39 "DefinedMemory(StaticModuleIndex(0), DefinedMemoryIndex(0))"
;;     gv0 = vmctx
