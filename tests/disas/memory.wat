...
;; @0025                               v6 = load.i64 notrap aligned readonly can_move checked v0+80
;; @0025                               v7 = iadd v6, v5
;; @0025                               store little heap v4, v7  ; v4 = 0
;; @0028                               v8 = iconst.i32 0
;; @002a                               v9 = uextend.i64 v8  ; v8 = 0
;; @002a                               v10 = load.i64 notrap aligned readonly can_move checked v0+80
...
;; @0033                               v16 = load.i64 notrap aligned readonly can_move checked v0+80
...
;; @003b                               v21 = load.i64 notrap aligned readonly can_move checked v0+80
