...
;;
;;                                 block2:
;; @0055                               v17 = load.i64 notrap aligned readonly v0+32
;; @0055                               v18 = load.i64 notrap aligned readonly v0+40
...
;;                                     v71 = iconst.i64 1
;; @0055                               v27 = iadd v26, v71  ; v71 = 1
;; @0055                               v29 = load.i64 notrap aligned readonly v0+32
;; @0055                               v30 = load.i64 notrap aligned readonly v0+40
...
;; @0055                               store.i64 table_oob aligned table v11, v39
;; @0055                               v40 = is_null.r64 v14
;; @0055                               brif v40, block7, block4
;;
;;                                 block4:
;; @0055                               v42 = load.i64 notrap aligned readonly v0+32
;; @0055                               v43 = load.i64 notrap aligned readonly v0+40
...
;;
;;                                 block5 cold:
;; @0055                               v55 = load.i64 notrap aligned readonly v0+72
;; @0055                               v56 = load.i64 notrap aligned readonly v55+200
;; @0055                               v57 = bitcast.i64 v14
;; @0055                               call_indirect sig0, v56(v0, v57)
;; @0055                               jump block7
;;
;;                                 block6:
;; @0055                               v59 = load.i64 notrap aligned readonly v0+32
;; @0055                               v60 = load.i64 notrap aligned readonly v0+40
;; @0055                               v61 = bitcast.i64 v14
;; @0055                               v62 = iconst.i64 8
;; @0055                               v63 = uadd_overflow_trap v61, v62, user65535  ; v62 = 8
;; @0055                               v64 = iconst.i64 8
;; @0055                               v65 = uadd_overflow_trap v63, v64, user65535  ; v64 = 8
;; @0055                               v66 = icmp ult v65, v60
;; @0055                               brif v66, block15, block14
;;
;;                                 block14 cold:
;; @0055                               trap user65535
;;
;;                                 block15:
;; @0055                               v67 = iadd.i64 v59, v63
;; @0055                               store.i64 notrap aligned v52, v67
;; @0055                               jump block7
;;
;;                                 block7:
;; @0057                               jump block1
...
;;
;;                                 block2:
;; @005e                               v17 = load.i64 notrap aligned readonly v0+32
;; @005e                               v18 = load.i64 notrap aligned readonly v0+40
...
;;                                     v71 = iconst.i64 1
;; @005e                               v27 = iadd v26, v71  ; v71 = 1
;; @005e                               v29 = load.i64 notrap aligned readonly v0+32
;; @005e                               v30 = load.i64 notrap aligned readonly v0+40
...
;; @005e                               store.i64 table_oob aligned table v11, v39
;; @005e                               v40 = is_null.r64 v14
;; @005e                               brif v40, block7, block4
;;
;;                                 block4:
;; @005e                               v42 = load.i64 notrap aligned readonly v0+32
;; @005e                               v43 = load.i64 notrap aligned readonly v0+40
...
;;
;;                                 block5 cold:
;; @005e                               v55 = load.i64 notrap aligned readonly v0+72
;; @005e                               v56 = load.i64 notrap aligned readonly v55+200
;; @005e                               v57 = bitcast.i64 v14
;; @005e                               call_indirect sig0, v56(v0, v57)
;; @005e                               jump block7
;;
;;                                 block6:
;; @005e                               v59 = load.i64 notrap aligned readonly v0+32
;; @005e                               v60 = load.i64 notrap aligned readonly v0+40
;; @005e                               v61 = bitcast.i64 v14
;; @005e                               v62 = iconst.i64 8
;; @005e                               v63 = uadd_overflow_trap v61, v62, user65535  ; v62 = 8
;; @005e                               v64 = iconst.i64 8
;; @005e                               v65 = uadd_overflow_trap v63, v64, user65535  ; v64 = 8
;; @005e                               v66 = icmp ult v65, v60
;; @005e                               brif v66, block15, block14
;;
;;                                 block14 cold:
;; @005e                               trap user65535
;;
;;                                 block15:
;; @005e                               v67 = iadd.i64 v59, v63
;; @005e                               store.i64 notrap aligned v52, v67
;; @005e                               jump block7
;;
;;                                 block7:
;; @0060                               jump block1
