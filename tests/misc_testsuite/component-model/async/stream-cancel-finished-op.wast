...
(component definition $A
  ...
  (core func $waitable-set.poll (canon waitable-set.poll (memory (core memory $libc "mem"))))
  ...
  (core func $future.read (canon future.read $f async (memory (core memory $libc "mem"))))
...
(component instance $A $A)
(assert_trap (invoke "test-cancel-future-write" (u32.const 2)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $A $A)
(assert_trap (invoke "test-cancel-future-write" (u32.const 3)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $A $A)
(assert_trap (invoke "test-cancel-future-write" (u32.const 4)) "cannot write to future after previous write succeeded or readable end dropped")
