...
(component definition $Tester
  (component $C
    ...
    (canon stream.write $ST (memory (core memory $memory "mem")) (core func $stream.write-sync))
...
(assert_trap (invoke "trap-after-future-reader-dropped" (u8.const 0)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $i3.1 $Tester)
(assert_trap (invoke "trap-after-future-reader-dropped" (u8.const 1)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $i3.2 $Tester)
(assert_trap (invoke "trap-after-future-reader-dropped" (u8.const 2)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $i3.3 $Tester)
(assert_trap (invoke "trap-after-future-reader-dropped" (u8.const 3)) "cannot write to future after previous write succeeded or readable end dropped")

(component instance $i $Tester)
(assert_trap (invoke "trap-after-future-reader-async-dropped" (u8.const 0)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $i $Tester)
(assert_trap (invoke "trap-after-future-reader-async-dropped" (u8.const 1)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $i $Tester)
(assert_trap (invoke "trap-after-future-reader-async-dropped" (u8.const 2)) "cannot write to future after previous write succeeded or readable end dropped")
(component instance $i $Tester)
(assert_trap (invoke "trap-after-future-reader-async-dropped" (u8.const 3)) "cannot write to future after previous write succeeded or readable end dropped")
...
(assert_trap (invoke "trap-after-stream-reader-eager-dropped" (u8.const 0)) "cannot write to stream after being notified that the readable end dropped")
(component instance $i6.1 $Tester)
(assert_trap (invoke "trap-after-stream-reader-eager-dropped" (u8.const 1)) "cannot write to stream after being notified that the readable end dropped")
(component instance $i7.0 $Tester)
(assert_trap (invoke "trap-after-stream-reader-async-dropped" (u8.const 0)) "cannot write to stream after being notified that the readable end dropped")
(component instance $i7.1 $Tester)
(assert_trap (invoke "trap-after-stream-reader-async-dropped" (u8.const 1)) "cannot write to stream after being notified that the readable end dropped")
(component instance $i8.0 $Tester)

(assert_trap (invoke "trap-after-stream-writer-eager-dropped" (u8.const 0)) "cannot read from stream after being notified that the writable end dropped")
(component instance $i8.1 $Tester)
(assert_trap (invoke "trap-after-stream-writer-eager-dropped" (u8.const 1)) "cannot read from stream after being notified that the writable end dropped")
...
(assert_trap (invoke "trap-after-stream-writer-async-dropped" (u8.const 0)) "cannot read from stream after being notified that the writable end dropped")
(component instance $i9.1 $Tester)
(assert_trap (invoke "trap-after-stream-writer-async-dropped" (u8.const 1)) "cannot read from stream after being notified that the writable end dropped")
