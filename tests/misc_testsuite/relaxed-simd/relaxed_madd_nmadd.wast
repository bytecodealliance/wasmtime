...
(module
    ...
    (func (export "f32x4.relaxed_fma_cmp") (param v128 v128 v128) (result v128)
          (f32x4.eq
            (f32x4.relaxed_fma (local.get 0) (local.get 1) (local.get 2))
            (f32x4.relaxed_fma (local.get 0) (local.get 1) (local.get 2))))
    (func (export "f32x4.relaxed_fnma_cmp") (param v128 v128 v128) (result v128)
          (f32x4.eq
            (f32x4.relaxed_fnma (local.get 0) (local.get 1) (local.get 2))
            (f32x4.relaxed_fnma (local.get 0) (local.get 1) (local.get 2))))
    (func (export "f64x2.relaxed_fnma_cmp") (param v128 v128 v128) (result v128)
          (f64x2.eq
            (f64x2.relaxed_fnma (local.get 0) (local.get 1) (local.get 2))
            (f64x2.relaxed_fnma (local.get 0) (local.get 1) (local.get 2))))
    (func (export "f64x2.relaxed_fma_cmp") (param v128 v128 v128) (result v128)
          (f64x2.eq
            (f64x2.relaxed_fma (local.get 0) (local.get 1) (local.get 2))
            (f64x2.relaxed_fma (local.get 0) (local.get 1) (local.get 2))))
)
...
;;   0       (if no fma)
;; from https://www.vinc17.net/software/fma-tests.c
(assert_return (invoke "f32x4.relaxed_fma_cmp"
                       (v128.const f32x4 0x1.fffffep+127 0x1.fffffep+127 0x1.fffffep+127 0x1.fffffep+127 )
                       (v128.const f32x4 2.0 2.0 2.0 2.0)
                       (v128.const f32x4 -0x1.fffffep+127 -0x1.fffffep+127 -0x1.fffffep+127 -0x1.fffffep+127))
...
(assert_return (invoke "f32x4.relaxed_fma_cmp"
               ...
               (v128.const i32x4 -1 -1 -1 -1))
;; fnma tests with negated x, same answers are expected.
(assert_return (invoke "f32x4.relaxed_fnma_cmp"
                       (v128.const f32x4 -0x1.000004p+0 -0x1.000004p+0 -0x1.000004p+0 -0x1.000004p+0)
                       (v128.const f32x4 0x1.0002p+0 0x1.0002p+0 0x1.0002p+0 0x1.0002p+0)
                       (v128.const f32x4 -0x1.000204p+0 -0x1.000204p+0 -0x1.000204p+0 -0x1.000204p+0))
               (v128.const i32x4 -1 -1 -1 -1))
...
;; form https://www.vinc17.net/software/fma-tests.c
;; from https://www.vinc17.net/software/fma-tests.c
(assert_return (invoke "f64x2.relaxed_fma_cmp"
                       (v128.const f64x2 0x1.fffffffffffffp+1023 0x1.fffffffffffffp+1023)
                       (v128.const f64x2 2.0 2.0)
                       (v128.const f64x2 -0x1.fffffffffffffp+1023 -0x1.fffffffffffffp+1023))
...
(assert_return (invoke "f64x2.relaxed_fma_cmp"
               ...
               (v128.const i64x2 -1 -1))
;; fnma tests with negated x, same answers are expected.
(assert_return (invoke "f64x2.relaxed_fnma_cmp"
                       (v128.const f64x2 -0x1.00000004p+0 -0x1.00000004p+0)
                       (v128.const f64x2 0x1.000002p+0 0x1.000002p+0)
                       (v128.const f64x2 -0x1.00000204p+0 -0x1.00000204p+0))
               (v128.const i64x2 -1 -1))
