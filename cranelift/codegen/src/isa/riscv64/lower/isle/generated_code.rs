...
// - D:\projects\wasmtime\cranelift\codegen\src\isa\riscv64\emulator_run_ci\target\debug\build\cranelift-codegen-c44ea77d42e67b2b\out\clif.isle
// - src\prelude.isle
...
/// Internal type I128ArithmeticOP: defined at src\isa\riscv64\inst.isle line 214.
...
/// Internal type IntSelectOP: defined at src\isa\riscv64\inst.isle line 224.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type ReferenceValidOP: defined at src\isa\riscv64\inst.isle line 232.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AtomicOP: defined at src\isa\riscv64\inst.isle line 237.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AtomicOP {
    LrW,
    ScW,
...
/// Internal type FloatFlagOp: defined at src\isa\riscv64\inst.isle line 262.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AluOPRRRR: defined at src\isa\riscv64\inst.isle line 273.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRRRR {
    FmaddS,
    FmsubS,
...
/// Internal type FClassResult: defined at src\isa\riscv64\inst.isle line 286.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AluOPRR: defined at src\isa\riscv64\inst.isle line 309.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRR {
    FsqrtS,
    FcvtWS,
...
/// Internal type LoadOP: defined at src\isa\riscv64\inst.isle line 349.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum LoadOP {
    Lb,
    Lh,
...
/// Internal type StoreOP: defined at src\isa\riscv64\inst.isle line 361.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum StoreOP {
    Sb,
    Sh,
...
/// Internal type AluOPRRR: defined at src\isa\riscv64\inst.isle line 370.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRRR {
    Add,
    Sub,
...
/// Internal type AluOPRRI: defined at src\isa\riscv64\inst.isle line 443.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRRI {
    Addi,
    Slti,
...
/// Internal type OPFPFMT: defined at src\isa\riscv64\inst.isle line 461.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum OPFPFMT {
    S,
    D,
...
/// Internal type FloatRoundingMode: defined at src\isa\riscv64\inst.isle line 473.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type FFlagsException: defined at src\isa\riscv64\inst.isle line 486.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type ExtendOp: defined at src\isa\riscv64\inst.isle line 513.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum ExtendOp {
    UXTB,
    UXTH,
...
/// Internal type Cond: defined at src\isa\riscv64\inst.isle line 525.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum Cond {
    Eq,
    Ne,
...
pub fn constructor_alu_rr<C: Context>(ctx: &mut C, arg0: &AluOPRR, arg1: Reg) -> Option<Reg> {
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src\isa\riscv64\inst.isle line 560.
...
pub fn constructor_alu_rrr<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src\isa\riscv64\inst.isle line 568.
    let expr0_0: Type = I64;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_alu_rrrr<C: Context>(
    ...
    let pattern2_0 = arg2;
    let pattern3_0 = arg3;
    // Rule at src\isa\riscv64\inst.isle line 576.
    let expr0_0: Type = I64;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_alu_rr_imm12<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src\isa\riscv64\inst.isle line 584.
    let expr0_0: Type = I64;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_narrow_int<C: Context>(ctx: &mut C, arg0: Type, arg1: Reg) -> Option<Reg> {
    ...
    if pattern0_0 == I8 {
        let pattern2_0 = arg1;
        // Rule at src\isa\riscv64\inst.isle line 591.
    ...
    if pattern0_0 == I16 {
        let pattern2_0 = arg1;
        // Rule at src\isa\riscv64\inst.isle line 593.
        let expr0_0 = AluOPRRI::Srli;
        let expr1_0 = AluOPRRI::Slli;
        let expr2_0: u64 = 48;
        let expr3_0 = C::imm_from_bits(ctx, expr2_0);
...
pub fn constructor_select_addi<C: Context>(ctx: &mut C, arg0: Type) -> Option<AluOPRRI> {
    ...
    if let Some(pattern1_0) = C::fits_in_32(ctx, pattern0_0) {
        // Rule at src\isa\riscv64\inst.isle line 609.
        let expr0_0 = AluOPRRI::Addiw;
        return Some(expr0_0);
    }
    if let Some(pattern1_0) = C::fits_in_64(ctx, pattern0_0) {
        // Rule at src\isa\riscv64\inst.isle line 610.
                ...
                &InstructionData::Binary {
                    ...
                    match pattern5_0 {
                        ...
                        &Opcode::Isub => {
                                ...
                                } = &pattern9_0
                                {
                                    if let &Opcode::Iconst = pattern10_0 {
                                        ...
                                        if let Some(pattern13_0) =
                                            C::imm12_from_u64(ctx, pattern12_0)
                                        {
                                            // Rule at src\isa\riscv64\lower.isle line 66.
                                            let expr0_0 = constructor_select_addi(ctx, pattern3_0)?;
                                            let expr1_0 = C::put_in_reg(ctx, pattern7_1);
                            ...
                            // Rule at src\isa\riscv64\lower.isle line 56.
