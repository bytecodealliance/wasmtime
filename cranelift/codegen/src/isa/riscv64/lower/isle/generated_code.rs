...
// - D:\projects\emulator_run_ci\target\debug\build\cranelift-codegen-c44ea77d42e67b2b\out\clif.isle
// - src\prelude.isle
...
/// Internal type I128ArithmeticOP: defined at src\isa\riscv64\inst.isle line 215.
...
/// Internal type IntSelectOP: defined at src\isa\riscv64\inst.isle line 225.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type ReferenceValidOP: defined at src\isa\riscv64\inst.isle line 233.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AtomicOP: defined at src\isa\riscv64\inst.isle line 238.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AtomicOP {
    LrW,
    ScW,
...
/// Internal type FloatFlagOp: defined at src\isa\riscv64\inst.isle line 263.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AluOPRRRR: defined at src\isa\riscv64\inst.isle line 274.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRRRR {
    FmaddS,
    FmsubS,
...
/// Internal type FClassResult: defined at src\isa\riscv64\inst.isle line 287.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type AluOPRR: defined at src\isa\riscv64\inst.isle line 310.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRR {
    FsqrtS,
    FcvtWS,
...
/// Internal type LoadOP: defined at src\isa\riscv64\inst.isle line 350.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum LoadOP {
    Lb,
    Lh,
...
/// Internal type StoreOP: defined at src\isa\riscv64\inst.isle line 362.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum StoreOP {
    Sb,
    Sh,
...
/// Internal type AluOPRRR: defined at src\isa\riscv64\inst.isle line 371.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRRR {
    Add,
    Sub,
...
/// Internal type AluOPRRI: defined at src\isa\riscv64\inst.isle line 444.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum AluOPRRI {
    Addi,
    Slti,
...
/// Internal type OPFPFMT: defined at src\isa\riscv64\inst.isle line 462.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum OPFPFMT {
    S,
    D,
...
/// Internal type FloatRoundingMode: defined at src\isa\riscv64\inst.isle line 474.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type FFlagsException: defined at src\isa\riscv64\inst.isle line 487.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
...
/// Internal type ExtendOp: defined at src\isa\riscv64\inst.isle line 514.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum ExtendOp {
    UXTB,
    UXTH,
...
/// Internal type Cond: defined at src\isa\riscv64\inst.isle line 526.
#[derive(Copy, Clone, PartialEq, Eq, Debug)]
pub enum Cond {
    Eq,
    Ne,
...
pub fn constructor_alu_rr<C: Context>(ctx: &mut C, arg0: &AluOPRR, arg1: Reg) -> Option<Reg> {
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src\isa\riscv64\inst.isle line 561.
...
pub fn constructor_alu_rrr<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src\isa\riscv64\inst.isle line 569.
    let expr0_0: Type = I64;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_alu_rr_imm12<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src\isa\riscv64\inst.isle line 585.
    let expr0_0: Type = I64;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_select_addi<C: Context>(ctx: &mut C, arg0: Type) -> Option<AluOPRRI> {
    ...
    if let Some(pattern1_0) = C::fits_in_64(ctx, pattern0_0) {
        // Rule at src\isa\riscv64\inst.isle line 611.
