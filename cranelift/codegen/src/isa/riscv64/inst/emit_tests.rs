...
fn test_riscv64_binemit() {
...

    {
        ...
        insns[0].code = Some(1752520083);
        insns[1].code = Some(1803900307);
        insns[2].code = Some(1213535635);
        insns[3].code = Some(1213552019);
        insns[4].code = Some(1750406547);
        insns[5].code = Some(676664723);
        insns[6].code = Some(1616205203);
        insns[7].code = Some(1616205211);
        insns[8].code = Some(139793819);
        insns[9].code = Some(1610945939);
        insns[10].code = Some(1610945947);
        insns[11].code = Some(1613043091);
        insns[12].code = Some(1613043099);
        insns[13].code = Some(1611994515);
        insns[14].code = Some(1611994523);
        insns[15].code = Some(1615140243);
        insns[16].code = Some(1616188819);
        insns[17].code = Some(134563259);
        insns[18].code = Some(678778259);
        insns[19].code = Some(134546875);
        insns[20].code = Some(1074099635);
        insns[21].code = Some(1208292787);
        insns[22].code = Some(1208309171);
        insns[23].code = Some(1745163699);
        insns[24].code = Some(671421875);
        insns[25].code = Some(168105395);
        insns[26].code = Some(168113587);
        insns[27].code = Some(168109491);
        insns[28].code = Some(168125875);
        insns[29].code = Some(168129971);
        insns[30].code = Some(168117683);
        insns[31].code = Some(168121779);
        insns[32].code = Some(1074095539);
        insns[33].code = Some(1610945971);
        insns[34].code = Some(1610945979);
        insns[35].code = Some(1610962355);
        insns[36].code = Some(1610962363);
        insns[37].code = Some(537208243);
        insns[38].code = Some(537208251);
        insns[39].code = Some(537216435);
        insns[40].code = Some(537216443);
        insns[41].code = Some(537224627);
        insns[42].code = Some(537224635);
        insns[43].code = Some(1074087347);
        insns[44].code = Some(263219);
        insns[45].code = Some(104924179);
        insns[46].code = Some(491575);
        insns[47].code = Some(491543);
        insns[48].code = Some(105186663);
        insns[49].code = Some(105219331);
        insns[50].code = Some(105235715);
        insns[51].code = Some(105223427);
        insns[52].code = Some(105239811);
        insns[53].code = Some(105227523);
        insns[54].code = Some(105243907);
        insns[55].code = Some(105231619);
        insns[56].code = Some(105227527);
        insns[57].code = Some(105231623);
        insns[58].code = Some(111215139);
        insns[59].code = Some(111219235);
        insns[60].code = Some(111223331);
        insns[61].code = Some(111227427);
        insns[62].code = Some(111223335);
        insns[63].code = Some(111227431);
        insns[64].code = Some(105186579);
        insns[65].code = Some(105194771);
        insns[66].code = Some(105198867);
        insns[67].code = Some(105202963);
        insns[68].code = Some(105215251);
        insns[69].code = Some(5575955);
        insns[70].code = Some(5592339);
        insns[71].code = Some(1079334163);
        insns[72].code = Some(126158107);
        insns[73].code = Some(5575963);
        insns[74].code = Some(5592347);
        insns[75].code = Some(1079334171);
        insns[76].code = Some(1079334171);
        insns[77].code = Some(11863347);
        insns[78].code = Some(1085605171);
        insns[79].code = Some(11867443);
        insns[80].code = Some(11871539);
        insns[81].code = Some(11875635);
        insns[82].code = Some(11879731);
        insns[83].code = Some(11883827);
        insns[84].code = Some(1085625651);
        insns[85].code = Some(11887923);
        insns[86].code = Some(11892019);
        insns[87].code = Some(11863355);
        insns[88].code = Some(1085605179);
        insns[89].code = Some(11867451);
        insns[90].code = Some(11883835);
        insns[91].code = Some(1085625659);
        insns[92].code = Some(45417779);
        insns[93].code = Some(45421875);
        insns[94].code = Some(45425971);
        insns[95].code = Some(45430067);
        insns[96].code = Some(45434163);
        insns[97].code = Some(45438259);
        insns[98].code = Some(45442355);
        insns[99].code = Some(45446451);
        insns[100].code = Some(45417787);
        insns[101].code = Some(45434171);
        insns[102].code = Some(45442363);
        insns[103].code = Some(45446459);
        insns[104].code = Some(11863379);
        insns[105].code = Some(146085203);
        insns[106].code = Some(280311123);
        insns[107].code = Some(414545235);
        insns[108].code = Some(548734291);
        insns[109].code = Some(548738387);
        insns[110].code = Some(548742483);
        insns[111].code = Some(682952019);
        insns[112].code = Some(682956115);
        insns[113].code = Some(2696226131);
        insns[114].code = Some(2696222035);
        insns[115].code = Some(2696217939);
        insns[116].code = Some(45446483);
        insns[117].code = Some(179664211);
        insns[118].code = Some(313881939);
        insns[119].code = Some(448099667);
        insns[120].code = Some(582288723);
        insns[121].code = Some(582292819);
        insns[122].code = Some(582296915);
        insns[123].code = Some(716506451);
        insns[124].code = Some(716510547);
        insns[125].code = Some(2729780563);
        insns[126].code = Some(2729776467);
        insns[127].code = Some(2729772371);
        insns[128].code = Some(1476756819);
        insns[129].code = Some(3221615955);
        insns[130].code = Some(3222664531);
        insns[131].code = Some(3758458195);
        insns[132].code = Some(3758462291);
        insns[133].code = Some(3490018643);
        insns[134].code = Some(3491067219);
        insns[135].code = Some(4026860883);
        insns[136].code = Some(3223680339);
        insns[137].code = Some(3224728915);
        insns[138].code = Some(3492115795);
        insns[139].code = Some(3493164371);
        insns[140].code = Some(1510339923);
        insns[141].code = Some(3255170387);
        insns[142].code = Some(3256218963);
        insns[143].code = Some(3792012627);
        insns[144].code = Some(3792016723);
        insns[145].code = Some(1075148115);
        insns[146].code = Some(3524592979);
        insns[147].code = Some(4060415315);
        insns[148].code = Some(3257234771);
        insns[149].code = Some(3258283347);
        insns[150].code = Some(3525670227);
        insns[151].code = Some(3526718803);
        insns[152].code = Some(2293564739);
        insns[153].code = Some(2293593415);
        insns[154].code = Some(2293593419);
        insns[155].code = Some(2293593423);
        insns[156].code = Some(2327147843);
        insns[157].code = Some(2327147847);
        insns[158].code = Some(2327147851);
        insns[159].code = Some(2327147855);
        insns[160].code = Some(335914287);
        insns[161].code = Some(449160495);
        insns[162].code = Some(147170607);
        insns[163].code = Some(12952879);
        insns[164].code = Some(549823791);
        insns[165].code = Some(1623565615);
        insns[166].code = Some(1086694703);
        insns[167].code = Some(2160436527);
        insns[168].code = Some(2697307439);
        insns[169].code = Some(3234178351);
        insns[170].code = Some(3771049263);
        insns[171].code = Some(335918383);
        insns[172].code = Some(449164591);
        insns[173].code = Some(147174703);
        insns[174].code = Some(12956975);
        insns[175].code = Some(549827887);
        insns[176].code = Some(1623569711);
        insns[177].code = Some(1086698799);
        insns[178].code = Some(2160440623);
        insns[179].code = Some(2697311535);
        insns[180].code = Some(3234182447);
        insns[181].code = Some(3771053359);
        insns[182].code = Some(267386895);
        insns[183].code = Some(4111);
        insns[184].code = Some(115);
        insns[185].code = Some(1048691);
    }
