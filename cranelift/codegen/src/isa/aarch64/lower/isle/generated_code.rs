...
pub fn constructor_csel<C: Context>(ctx: &mut C, arg0: &Cond, arg1: Reg, arg2: Reg) -> Option<Reg> {
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    ...
    if let Some(pattern1_0) = C::integral_ty(ctx, pattern0_0) {
        ...
        if let Some(pattern3_0) = closure3() {
            if let Some(pattern4_0) = C::imm_logic_from_u64(ctx, pattern2_0, pattern3_0) {
                // Rule at src/isa/aarch64/inst.isle line 1582.
        ...
        if pattern2_0 == I64 {
            ...
            } = &pattern4_0
            {
                match &pattern5_0 {
                    ...
                    &Opcode::Ushr => {
                        let (pattern7_0, pattern7_1) = C::unpack_value_array_2(ctx, &pattern5_1);
                        // Rule at src/isa/aarch64/lower.isle line 804.
...
pub fn constructor_lower_shl128<C: Context>(
    ...
    let expr17_0 = ALUOp::AndS64;
    let expr18_0 = C::writable_zero_reg(ctx);
    let expr19_0: Type = I64;
    let expr20_0: u64 = 64;
    let expr21_0 = C::u64_into_imm_logic(ctx, expr19_0, expr20_0);
    let expr22_0 = MInst::AluRRImmLogic {
        alu_op: expr17_0,
        rd: expr18_0,
        rn: pattern1_0,
        imml: expr21_0,
    };
    let expr23_0 = C::emit(ctx, &expr22_0);
    let expr24_0 = ALUOp::Orr64;
    let expr25_0 = constructor_alu_rrr(ctx, &expr24_0, expr7_0, expr16_0)?;
    let expr26_0 = Cond::Ne;
    let expr27_0 = constructor_csel(ctx, &expr26_0, expr5_0, expr25_0)?;
    let expr28_0 = Cond::Ne;
    let expr29_0 = C::zero_reg(ctx);
    let expr30_0 = constructor_csel(ctx, &expr28_0, expr29_0, expr5_0)?;
    let expr31_0 = C::value_regs(ctx, expr30_0, expr27_0);
...
pub fn constructor_lower_ushr128<C: Context>(
    ...
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/aarch64/lower.isle line 829.
    let expr0_0: usize = 0;
    let expr1_0 = C::value_regs_get(ctx, pattern0_0, expr0_0);
    let expr2_0: usize = 1;
    let expr3_0 = C::value_regs_get(ctx, pattern0_0, expr2_0);
    ...
    let expr23_0 = C::emit(ctx, &expr22_0);
    let expr24_0 = ALUOp::Orr64;
    let expr25_0 = constructor_alu_rrr(ctx, &expr24_0, expr5_0, expr16_0)?;
    let expr26_0 = Cond::Ne;
    let expr27_0 = C::zero_reg(ctx);
    let expr28_0 = constructor_csel(ctx, &expr26_0, expr27_0, expr7_0)?;
    let expr29_0 = Cond::Ne;
    let expr30_0 = constructor_csel(ctx, &expr29_0, expr7_0, expr25_0)?;
    let expr31_0 = C::value_regs(ctx, expr30_0, expr28_0);
    return Some(expr31_0);
}
...
pub fn constructor_lower_sshr128<C: Context>(
    ...
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/aarch64/lower.isle line 890.
    let expr0_0: usize = 0;
    let expr1_0 = C::value_regs_get(ctx, pattern0_0, expr0_0);
    let expr2_0: usize = 1;
    let expr3_0 = C::value_regs_get(ctx, pattern0_0, expr2_0);
    ...
    let expr23_0 = C::emit(ctx, &expr22_0);
    let expr24_0 = ALUOp::Asr64;
    let expr25_0: u8 = 63;
    let expr26_0 = C::imm_shift_from_u8(ctx, expr25_0);
    let expr27_0 = constructor_alu_rr_imm_shift(ctx, &expr24_0, expr3_0, expr26_0)?;
    let expr28_0 = ALUOp::Orr64;
    let expr29_0 = constructor_alu_rrr(ctx, &expr28_0, expr5_0, expr16_0)?;
    let expr30_0 = Cond::Ne;
    let expr31_0 = constructor_csel(ctx, &expr30_0, expr27_0, expr7_0)?;
    let expr32_0 = Cond::Ne;
    let expr33_0 = constructor_csel(ctx, &expr32_0, expr7_0, expr29_0)?;
    let expr34_0 = C::value_regs(ctx, expr33_0, expr31_0);
    return Some(expr34_0);
}
