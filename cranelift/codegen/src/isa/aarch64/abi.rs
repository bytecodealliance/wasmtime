...
impl ABIMachineSpec for AArch64MachineDeps {
    ...
    fn gen_load_stack(mem: StackAMode, into_reg: Writable<Reg>, ty: Type) -> Inst {
        Inst::gen_load(into_reg, mem.into(), ty, ir::MemFlags::trusted())
    }

    fn gen_store_stack(mem: StackAMode, from_reg: Reg, ty: Type) -> Inst {
        Inst::gen_store(mem.into(), from_reg, ty, ir::MemFlags::trusted())
    }
    ...
    fn gen_load_base_offset(into_reg: Writable<Reg>, base: Reg, offset: i32, ty: Type) -> Inst {
        ...
        Inst::gen_load(into_reg, mem, ty, ir::MemFlags::trusted())
    }
    ...
    fn gen_store_base_offset(base: Reg, offset: i32, from_reg: Reg, ty: Type) -> Inst {
        ...
        Inst::gen_store(mem, from_reg, ty, ir::MemFlags::trusted())
    }
