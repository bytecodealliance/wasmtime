...
/// Intermidate representation for the unwind information
...
pub mod input {
    ...
    pub enum UnwindCode<Reg> {
        /// Defines that a register is saved at the speficied offset.
        SaveRegister {
            /// The saved register.
            reg: Reg,
            /// The speficied offset relative to the stack pointer.
            stack_offset: u32,
        },
