...
fn test_x64_emit() {
    ...
    insns.push((
        Inst::LockCmpxchg {
            ty: types::I8,
            mem: am1,
            replacement: Gpr::unwrap_new(rbx),
            expected: Gpr::unwrap_new(rax),
    ...
    insns.push((
        Inst::LockCmpxchg {
            ty: types::I8,
            mem: am2.clone(),
            replacement: Gpr::unwrap_new(rdx),
            expected: Gpr::unwrap_new(rax),
            dst_old: w_rax.map(Gpr::unwrap_new),
        },
        "F00FB094F1C7CFFFFF",
    ...
    insns.push((
        Inst::LockCmpxchg {
            ty: types::I8,
            mem: am2.clone(),
            replacement: Gpr::unwrap_new(rsi),
            expected: Gpr::unwrap_new(rax),
            dst_old: w_rax.map(Gpr::unwrap_new),
        },
    ...
    insns.push((
        Inst::LockCmpxchg {
            ty: types::I8,
            mem: am2.clone(),
            replacement: Gpr::unwrap_new(r10),
            expected: Gpr::unwrap_new(rax),
            dst_old: w_rax.map(Gpr::unwrap_new),
        },
    ...
    insns.push((
        Inst::LockCmpxchg {
            ty: types::I8,
            mem: am2.clone(),
            replacement: Gpr::unwrap_new(r15),
            expected: Gpr::unwrap_new(rax),
            dst_old: w_rax.map(Gpr::unwrap_new),
        },
    ...
    insns.push((
        Inst::LockCmpxchg16b {
            ...
            replacement_low: Gpr::unwrap_new(rbx),
            replacement_high: Gpr::unwrap_new(rcx),
            expected_low: Gpr::unwrap_new(rax),
            expected_high: Gpr::unwrap_new(rdx),
