...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        inst("roundsd", fmt("RMI", [w(xmm1), r(align(xmm_m128)), r(imm8)]), rex([0x66, 0x0F, 0x3A, 0x0B]).ib(), _64b | compat | sse41),
        inst("roundss", fmt("RMI", [w(xmm1), r(align(xmm_m128)), r(imm8)]), rex([0x66, 0x0F, 0x3A, 0x0A]).ib(), _64b | compat | sse41),
