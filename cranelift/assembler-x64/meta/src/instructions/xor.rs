...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        inst("xorw", fmt("I", [rw(ax), r(imm16)]), rex(0x35).prefix(_66).iw(), _64b | compat),
        ...
        inst("xorw", fmt("MI", [rw(rm16), r(imm16)]), rex(0x81).prefix(_66).digit(6).iw(), _64b | compat),
        ...
        inst("xorw", fmt("MR", [rw(rm16), r(r16)]), rex(0x31).prefix(_66).r(), _64b | compat),
        ...
        inst("xorw", fmt("RM", [rw(r16), r(rm16)]), rex(0x33).prefix(_66).r(), _64b | compat),
