...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        inst("cmpq", fmt("I_SXL", [r(rax), sxq(imm32)]).flags(W), rex(0x3D).w().id(), _64b),
        ...
        inst("cmpq", fmt("MI_SXL", [r(rm64), sxq(imm32)]).flags(W), rex(0x81).w().digit(7).id(), _64b),
        inst("cmpw", fmt("MI_SXW", [r(rm16), sxw(imm8)]).flags(W), rex([0x66, 0x83]).digit(7).ib(), _64b | compat),
        inst("cmpl", fmt("MI_SXB", [r(rm32), sxl(imm8)]).flags(W), rex(0x83).digit(7).ib(), _64b | compat),
        inst("cmpq", fmt("MI_SXB", [r(rm64), sxq(imm8)]).flags(W), rex(0x83).w().digit(7).ib(), _64b),
        inst("cmpb", fmt("MR", [r(rm8), r(r8)]).flags(W), rex(0x38).r(), _64b | compat),
        inst("cmpw", fmt("MR", [r(rm16), r(r16)]).flags(W), rex([0x66, 0x39]).r(), _64b | compat),
        inst("cmpl", fmt("MR", [r(rm32), r(r32)]).flags(W), rex(0x39).r(), _64b | compat),
        inst("cmpq", fmt("MR", [r(rm64), r(r64)]).flags(W), rex(0x39).w().r(), _64b),
        inst("cmpb", fmt("RM", [r(r8), r(rm8)]).flags(W), rex(0x3A).r(), _64b | compat),
        inst("cmpw", fmt("RM", [r(r16), r(rm16)]).flags(W), rex([0x66, 0x3B]).r(), _64b | compat),
        inst("cmpl", fmt("RM", [r(r32), r(rm32)]).flags(W), rex(0x3B).r(), _64b | compat),
        inst("cmpq", fmt("RM", [r(r64), r(rm64)]).flags(W), rex(0x3B).w().r(), _64b),
        // Vector instructions
