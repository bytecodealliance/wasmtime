...
use crate::dsl::{Feature::*, Inst, LegacyPrefixes::*, Location::*};
...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        //inst("andb", fmt("MI_W", [rw(rm8), r(imm8)]), rex(0x80).w().digit(4).ib(), _64b),
        ...
        //inst("andw", fmt("MI_SXBW", [rw(rm16), sxw(imm8)]), rex(0x83).digit(4).ib(), _64b | compat),
