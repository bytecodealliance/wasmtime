...
;;                                     v43 -> v1
;;                                     v45 -> v1
;;                                     v36 = load.i64 notrap aligned v1+8
;;                                     v6 -> v36
;;                                     v38 = load.i64 notrap aligned v1
;;                                     v8 -> v38
;; @0047                               v5 = uextend.i64 v0
;; @0047                               v7 = icmp ugt v5, v36
...
;;                                     v40 -> v4
;;                                     v42 -> v4
;;                                     v33 = load.i64 notrap aligned v4+8
;;                                     v6 -> v33
;;                                     v35 = load.i64 notrap aligned v4
;;                                     v8 -> v35
;; @005d                               v5 = uextend.i64 v0
;; @005d                               v7 = icmp ugt v5, v33
