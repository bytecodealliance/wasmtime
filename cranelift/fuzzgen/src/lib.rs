    ...
    'data: 'r,
{
    ...
    pub fn generate_flags(&mut self, target_arch: Architecture) -> Result<Flags> {
        ...
        // TODO find a proper way to specify fuel parameter. The value
        // should NOT be generated by the fuzzer. The purpose of this flag
        // is to control chaos mode manually.
        builder.set("chaos_mode_fuel", "10")?;
