...
pub struct DataDescription {
    ...
    pub data_decls: PrimaryMap<ir::Template, ir::ExternalName>,
    ...
    pub data_relocs: Vec<(CodeOffset, ir::Template, Addend)>,
}
...
impl DataContext {
    ...
    /// the appropriate `ExternalName`.
    pub fn import_global_variable(&mut self, name: ir::ExternalName) -> ir::Template {
    ...
    pub fn write_data_addr(&mut self, offset: CodeOffset, data: ir::Template, addend: Addend) {
...
mod tests {
    ...
    fn basic_data_context() {
        ...
        let _data_a = data_ctx.import_global_variable(ir::ExternalName::user(2, 2));
        let data_b = data_ctx.import_global_variable(ir::ExternalName::user(2, 3));
