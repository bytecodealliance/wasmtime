use super::regs;
use crate::{
    abi::{ABIOperand, ABIParams, ABIResults, ABISig, ParamsOrReturns, ABI},
...
impl ABI for X64ABI {
    ...
    fn sig_from(
        ...
        let params = ABIParams::from(params, params_stack_offset, |ty, stack_offset| {
            Self::to_abi_operand(
                ty,
                stack_offset,
    ...
    fn abi_results(returns: &[WasmType], call_conv: &CallingConvention) -> ABIResults {
        let mut results_index_env = RegIndexEnv::default();
        ABIResults::from(returns, |ty, offset| {
            Self::to_abi_operand(
                ty,
                offset,
...
mod tests {
    ...
    fn int_abi_sig_multi_returns() {
        ...
        match_reg_arg(results.get(1).unwrap(), I32, regs::rdx());
    ...
    fn fastcall_call_conv() {
        ...
        match_reg_arg(params.get(3).unwrap(), F64, regs::xmm3());
        // TODO: Should this be type-sized?
    ...
    fn fastcall_call_conv_multi_returns() {
        ...
        match_reg_arg(results.get(2).unwrap(), I32, regs::rdx());
        // TODO: Should this be type-sized?
