...
impl command::wasi::types::Host for WasiCtx {
    ...
    ) -> wasmtime::Result<command::wasi::types::Method> {
        anyhow::bail!("not implemented")
    }
    ...
    async fn incoming_request_scheme(
        &mut self,
        _request: IncomingRequest,
    ) -> wasmtime::Result<Option<command::wasi::types::Scheme>> {
        anyhow::bail!("not implemented")
    }
    ...
    async fn new_outgoing_request(
        &mut self,
        _method: command::wasi::types::Method,
        _path: String,
        _query: String,
        _scheme: Option<command::wasi::types::Scheme>,
        _authority: String,
        _headers: Headers,
    ...
    async fn set_response_outparam(
        &mut self,
        _response: Result<command::wasi::types::OutgoingResponse, command::wasi::types::Error>,
    ...
    async fn future_incoming_response_get(
        &mut self,
        _f: FutureIncomingResponse,
    ) -> wasmtime::Result<Option<Result<IncomingResponse, command::wasi::types::Error>>> {
        anyhow::bail!("not implemented")
    }
...
#[async_trait::async_trait]
impl proxy::wasi::types::Host for WasiCtx {
    async fn drop_fields(&mut self, _fields: Fields) -> wasmtime::Result<()> {
        anyhow::bail!("not implemented")
    }
    async fn new_fields(&mut self, _entries: Vec<(String, String)>) -> wasmtime::Result<Fields> {
